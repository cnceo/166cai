...
/*
 * --------------------------------------------------------------- APPLICATION ENVIRONMENT --------------------------------------------------------------- You can load different configurations depending on your current environment. Setting the environment also influences things like logging and error reporting. This can be set to anything, but default usage is: development testing production nonotice NOTE: If you change these, also change the error_reporting() code below
 */
$ENVFILE = file_get_contents ( dirname ( __DIR__ ) . DIRECTORY_SEPARATOR . 'ENV.CON' );
define ( 'ENVIRONMENT', $ENVFILE );
/*
 ...
 */
$application_folder = '../application/chansys';
