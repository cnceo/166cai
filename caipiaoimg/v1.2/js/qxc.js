(function() {
	...
	cx.Lottery = (function(){
	    ...
	    me.getRule = function(playType, state) {
	    	if (state[0].indexOf('1') > -1)  return {'status':false, 'content':'<i class="icon-font">&#xe611;</i>每位至少选择<span class="num-red">１</span>个号码', 'size':'18'}
...
$(function() {
    ...
    basket = new cx.CastBasket('.cast-basket', {boxes: boxes, setMoney: 5000, chases: chase, chaseLength: chaselength, multi: MULTI, multiModifier: multiModifier});
    cx._basket_ = basket;
