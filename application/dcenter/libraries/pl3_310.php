...
class Pl3_310
{
    ...
    public function capture($param,$data)
    {
        ...
        if(!empty($data['issues']))
        {
            ...
            foreach ($data['issues'] as $issues) {
                //$issues = '';    //2015073
                $url = 'http://www.310win.com/pailie3/kaijiang_sz_26.html';
    ...
    {
        //开奖详情请求接口
        $request_url = "http://www.310win.com/Info/Result/Numeric.aspx?load=ajax&typeID=44&IssueID={$issueID}&randomT-_-=" . time();
