...
if (ENVIRONMENT === 'production') {
    ...
    $config['cmd_path'] = '/opt/case/www.166cai.com/dcenter/index.php';
...
elseif (ENVIRONMENT === 'checkout') {
    ...
    $config['cmd_path'] = 'D:\wamp\web\cpbranch\dcenter\index.php';
    $config['log_threshold'] = 5; //日志配置
}
...
$config['REDIS'] = array(
		...
		'SYXW_KJ'     => '_syxw_kj:',
		'SYXW_ISSUE'  => '_syxw_issue:',
		'SYXW_AWARD'  => '_syxw_award:',
		'JXSYXW_KJ'   => '_jxsyxw_kj:',
		'JXSYXW_ISSUE'=> '_jxsyxw_issue:',
		'JXSYXW_AWARD'=> '_jxsyxw_award:',
		'HBSYXW_KJ'   => '_hbsyxw_kj:',
		'HBSYXW_ISSUE'=> '_hbsyxw_issue:',
		'HBSYXW_AWARD'=> '_hbsyxw_award:',
        'GDSYXW_KJ'   => '_gdsyxw_kj:',
        'GDSYXW_ISSUE'=> '_gdsyxw_issue:',
		...
		'KLPK_KJ'         => '_klpk_kj:',
		'KLPK_ISSUE'      => '_klpk_issue:',
		'KLPK_AWARD'      => '_klpk_award:',
		'CQSSC_KJ'        => '_cqssc_kj:',
		'CQSSC_ISSUE'     => '_cqssc_issue:',
