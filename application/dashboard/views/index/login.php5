...
<body>
	...
	<div class="wrapper">
		<div class="loginPop">
			<div class="tit">166彩票合作商管理系统</div>
			<form action="" method="post" id="login">
				<ul class="loginForm clearfix">
					...
					<li><span class="sTit">账号</span><span class="sInput"><i
							...
							value="用户名/邮箱" name="name"><a href="javascript:void(0);"
							target="_self" class="aDelete" style="display: block"></a></span></li>
