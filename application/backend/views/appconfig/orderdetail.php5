...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      ...
      <li<?php if ($con == 'Appconfig' && $act == 'orderdetail' && $platform == 'android') {?> class="current"<?php }?>><a href="/backend/Appconfig/orderdetail/android">Android订单详情</a></li>
      <li<?php if ($con == 'Appconfig' && $act == 'orderdetail' && $platform == 'ios') {?> class="current"<?php }?>><a href="/backend/Appconfig/orderdetail/ios">ios订单详情</a></li>
...
<script>
    $(function() {
        ...
        $(".upload").click(function(){
            ...
            uploader.options.server = "/backend/Appconfig/uploadorderdetail/" + platform + "/" + $(this).data('index');
