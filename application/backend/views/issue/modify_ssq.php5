            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="ipt w150 none_input" name="3dj_dzjj" value="3000" readonly='true' ></td>
                    </tr>
                    <tr>
                        <td>四等奖</td>
                        <td><input type="text" class="ipt w150" name="4dj_zs" value="<?php echo $bonusDetail['4dj']['zs'];?>"></td>
                        <td><input type="text" class="ipt w150 none_input" name="4dj_dzjj" value="200" readonly='true' ></td>
                    </tr>
                    <tr>
                        <td>五等奖</td>
                        <td><input type="text" class="ipt w150" name="5dj_zs" value="<?php echo $bonusDetail['5dj']['zs'];?>"></td>
                        <td><input type="text" class="ipt w150 none_input" name="5dj_dzjj" value="10" readonly='true' ></td>
                    </tr>
                    <tr>
                        <td>六等奖</td>
                        <td><input type="text" class="ipt w150" name="6dj_zs" value="<?php echo $bonusDetail['6dj']['zs'];?>"></td>
                        <td><input type="text" class="ipt w150 none_input" name="6dj_dzjj" value="5" readonly='true' ></td>
                    </tr>                
                </tbody>
            </table>
...
<script>
    ...
    $("#submit").click(function(){
        ...
        if(redBall.length != 6)
        {
            layer.alert('请输入6个红球号码~', {icon: 2,btn:'',title:'温馨提示',time:0});
            return false;
        }
        for(var i in redBall)
        {
            ...
            if(redBall[i] < 0 || redBall[i] > 33)
            {
                layer.alert('红球号码范围为01-33~', {icon: 2,btn:'',title:'温馨提示',time:0});
                return false;
            }
        }
        //篮球规则
        disBall = preBall[1].split('(');
        blueBall = preBall[1].split(',');
        if(blueBall.length != 1)
        {
            layer.alert('请输入1个蓝球号码~', {icon: 2,btn:'',title:'温馨提示',time:0});
            return false;
        }
        if(blueBall[0] < 0 || blueBall[0] > 16)
        {
            layer.alert('蓝球号码范围为01-16~', {icon: 2,btn:'',title:'温馨提示',time:0});
            return false;
        }
        // if(blueBall[0].length < 2)
        // {
        //     blueBall[0] 
        // }
