                        ...
                        <tr>
                            ...
                            <td>
                                <div class="num-box">
                                    ...
                                    <span class="cBlue">特别</span>
                                    <input type="text" data-val='7' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                </div>
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="num-box">
                                    ...
                                    <span class="cBlue">特别</span>
                                    <input type="text" name='awardNums[]' data-val='7' class="inputTxt1" value="" maxlength="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="num-box">
                                    ...
                                    <span class="cBlue">特别</span>
                                    <input type="text" name='awardNums[]' data-val='7' class="inputTxt2" value="" maxlength="2">
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
$(function(){
  ...
  $(document).on('click', '.shBtn', function(){
    ...
    awardNumObj.each(function(index){
        if($.inArray($(this).val(),awardNumArr)!==-1 || $.inArray($(this).val(),balls)==-1)
        {
    ...
    var temp = awardNumArr.slice(0,changeIndex);
    if((temp.slice()).toString()!=(temp.sort()).toString())
    {
      layer.alert('输入的开奖号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
      return;
    }
    awardNumStr = temp.join(',')+'('+awardNumArr[changeIndex]+')';
    //验证是否正确
  ...
  $(document).on('click', '.hmBtn', function(){
    ...
    $('.inputTxt1').each(function(index){
      if($(this).val()!=$('.inputTxt2').eq(index).val())
      {
        ...
        return ;
          ...
          if($.inArray($(this).val(),tempAward)!==-1  || $.inArray($(this).val(),balls)==-1)
          {
            tag = false;
    ...
    var temp = tempAward.slice(0,changeIndex);
    if((temp.slice()).toString()!=(temp.sort()).toString())
    {
      layer.alert('输入的号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
      return;
    }
    awardNumStr = temp.join(',')+'('+tempAward[changeIndex]+')';
    if(tag===false) return ;
    //录入号码操作
    layer.load(0, {shade: [0.5, '#393D49']});
    $.ajax({
