                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="num-box">
                                  <?php if($search['type']=='ssq'): ?> 
                                    <input type="text" data-val='0' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='1' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='2' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='3' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='4' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='5' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <span class="cBlue">蓝色</span>
                                    <input type="text" data-val='6' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                  <?php elseif($search['type']=='dlt'): ?>
                                    <span class="cRed">前</span>
                                    <input type="text" data-val='0' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='1' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='2' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='3' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='4' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <span class="cBlue">后</span>
                                    <input type="text" data-val='5' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                    <input type="text" data-val='6' class='inputTxt' name='awardNums[]' value="" maxlength="2">
                                  <?php else: ?>
                                  <?php endif; ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                              <?php if($search['type']=='ssq'): ?> 
                                <div class="num-box">
                                    <span class="cRed">红</span>
                                    <input type="text" name='awardNums[]' data-val='0' class="inputTxt1" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='1' class="inputTxt1" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='2' class="inputTxt1" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='3' class="inputTxt1" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='4' class="inputTxt1" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='5' class="inputTxt1" value="" maxlength="2">
                                    <span class="cBlue">蓝</span>
                                    <input type="text" name='awardNums[]' data-val='6' class="inputTxt1" value="" maxlength="2">
                                </div>
                              <?php elseif($search['type']=='dlt'): ?>
                                <div class="num-box">
                                    <span class="cRed">前</span>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php if($search['type']=='ssq'): ?>
                                <div class="num-box">
                                    <span class="cRed">红</span>
                                    <input type="text" name='awardNums[]' data-val='0' class="inputTxt2" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='1' class="inputTxt2" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='2' class="inputTxt2" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='3' class="inputTxt2" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='4' class="inputTxt2" value="" maxlength="2">
                                    <input type="text" name='awardNums[]' data-val='5' class="inputTxt2" value="" maxlength="2">
                                    <span class="cBlue">蓝</span>
                                    <input type="text" name='awardNums[]' data-val='6' class="inputTxt2" value="" maxlength="2">
                                </div>
                              <?php elseif($search['type']=='dlt'): ?>
                                <div class="num-box">
                                    <span class="cRed">前</span>
...
<script type="text/javascript">
  ...
  var aduitflag = 0;
  var changeIndex = <?php if($search['type']=='ssq'): ?> 6 <?php elseif($search['type']=='dlt'): ?> 5 <?php else: ?> <?php endif; ?>;
  var bigIndex = <?php if($search['type']=='ssq'): ?> 6 <?php elseif($search['type']=='dlt'): ?> 6 <?php else: ?> <?php endif; ?>;
  var allCapacity = ("<?php echo $allCapacity;?>").split(",");
</script>
<script src="/caipiaoimg/v1.0/js/admin/management.js"></script>
<script>
$(function(){
  var _JPre = <?php if($search['type']=='ssq'): ?> getCode(33,1) <?php elseif($search['type']=='dlt'): ?> getCode(35,1) <?php else: ?> <?php endif; ?>;//红球区域
  var _JNext = <?php if($search['type']=='ssq'): ?> getCode(16,1) <?php elseif($search['type']=='dlt'): ?> getCode(12,1) <?php else: ?> <?php endif; ?>;//篮球区域
  //审核提交处理 shBtn
  $(document).on('click', '.shBtn', function(){
    
    var awardNumObj = $("#pop_sh_"+type).find('.inputTxt');
    var awardNumStr = '';
    var awardNumArr1 = new Array();//后区
    var awardNumArr2 = new Array();//前区
    var preawardNum = new Array
    awardNumObj.each(function(index){
      if(index>=changeIndex){
        if($.inArray($(this).val(),awardNumArr1)!==-1)
        {
          layer.alert('输入的开奖号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
          return;
        }
        awardNumArr1.push($(this).val());
      }else{
        if($.inArray($(this).val(),awardNumArr2)!==-1)
        {
          layer.alert('输入的开奖号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
          return;
        }
        awardNumArr2.push($(this).val());
      }
    });

    if( (awardNumArr2.slice()).toString()!=(awardNumArr2.sort()).toString() ||
        (awardNumArr1.slice()).toString()!=(awardNumArr1.sort()).toString()
      )
    {
      layer.alert('输入的开奖号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
      return;
    }
    awardNumStr = awardNumArr2.join(',')+'|'+awardNumArr1.join(',');
    //验证是否正确
  ...
  $(document).on('click', '.hmBtn', function(){
    ...
    $('.inputTxt1').each(function(index){
      if($(this).val()!=$('.inputTxt2').eq(index).val())
      {
        ...
        if(index>=changeIndex)
        {
          if($.inArray($(this).val(),tempAward1)!==-1)
          {
            tag = false;
            layer.alert('输入的号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
            return;
          }
          tempAward1.push($(this).val());
        }else{
          if($.inArray($(this).val(),tempAward)!==-1)
          {
            tag = false;
            layer.alert('输入的号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
            return;
    ...
    if( (tempAward.slice()).toString()!=(tempAward.sort()).toString() ||
        (tempAward1.slice()).toString()!=(tempAward1.sort()).toString()
      )
    {
      layer.alert('输入的号码格式不正确~', {icon: 2,btn:'',title:'温馨提示',time:0});
      return;
    }
    awardNumStr = tempAward.join(',')+'|'+tempAward1.join(',');
    if(tag===false) return ;
    layer.load(0, {shade: [0.5, '#393D49']});
    //录入号码操作
    $.ajax({
  ...
  $(document).on('keyup', '.inputTxt,.inputTxt1,.inputTxt2', function(){
      ...
      if(($(this).val()).length == 2 && (_JIndex < $(className).length)  )
      {
        //对前区后区判断
        if( 
          (_JIndex < bigIndex && _JPre.indexOf($(this).val()) == -1 )||
          (_JIndex == bigIndex && _JNext.indexOf($(this).val()) == -1 )
         ){
          $(this).val('').focus();
        }else{
