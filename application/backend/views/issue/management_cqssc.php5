    ...
    <table>
      ...
      <tr>
        <td colspan="9">
          ...
          <?php if(in_array($search['type'], array('cqssc'))): ?>
			  ...
			  <div class="pop-body">
				  <div class="data-table-filter del-percent">
					  <table>
						  ...
						  <tfoot>
						  <tr>
							  <td colspan="2"><p>输入开奖号码格式为0 - 9</p></td>
						  </tr>
						  <tr>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="num-box">
                                      ...
                                      <input name="awardnum[3]" type="text" value="" maxlength="1">
                                      <input name="awardnum[4]" type="text" value="" maxlength="1">
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="num-box">
                                      ...
                                      <input name="awardnumAgain[3]" type="text" value="" maxlength="1">
                                      <input name="awardnumAgain[4]" type="text" value="" maxlength="1">
                                  </div>
                              </td>
                          </tr>
						  </tbody>
