...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      ...
      <li class="current"><a href="/backend/Match/bdsfgg">北单胜负过关</a></li>
...
$(function(){
	...
	$('#mid').change(function(){
		...
		window.location.href="/backend/Match/bdsfgg/?mid="+ mid;
	});
	...
	$("#cancel").click(function(){
		...
		var title = td.eq(0).html() + " " + td.eq(3).html() + " vs " + td.eq(4).html();
		$("#pop_name").html(title);
		$("#cancelId").val(id);
		popdialog("cancelPop");
	});
	...
	$("#timeSubmit").click(function(){
		$.ajax({
            type: "post",
            url: '/backend/Match/sfgg_update_time',
	...
	$("#score").click(function(){
        ...
        $("#scoreSubmit").click(function(){
            $.ajax({
                type: "post",
                url: '/backend/Match/sfgg_update_score',
