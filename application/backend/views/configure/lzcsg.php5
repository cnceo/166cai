...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      ...
      <li class="current"><a href="/backend/Configure/lzcsg/">老足彩赛果</a></li>
      <li><a href="/backend/Configure/jlks/">快3期次更新</a></li>
    </ul>
  </div>
  <div>
  <div class="data-table-filter">
  		<form action="/backend/Configure/lzcsg/" method="get"  id="search_form">
          <table>
            <tbody>
            <tr>
              <td colspan="4">
...
$(function(){
	...
	$("#updateSubmit").click(function(){
		...
		$.ajax({
            ...
            data: $("#updateForm").serialize()+ '&type ='+ type+ '&names =老足彩赛果',
