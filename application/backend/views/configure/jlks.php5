...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      ...
      <li><a href="/backend/Configure/dzzq/">对阵抓取</a></li>
      <li><a href="/backend/Configure/bfzq/">比分抓取</a></li>
      <li><a href="/backend/Configure/lzcsg/">老足彩赛果</a></li>
      <li class="current"><a href="/backend/Configure/jlks/">快3期次更新</a></li>
    </ul>
  </div>
  <div>
  <div class="data-table-filter">
          ...
          <table>
            ...
            <tr>
              <td colspan="4">
                <select class="selectList w222" id="lid" name="lid">
                  <?php foreach ($lidArr as $l => $name): ?>
                  <option value="<?php echo $l;?>" <?php if($lid == $l): echo "selected"; endif;   ?>><?php echo $name['cname'];?></option>
                  <?php endforeach; ?>
                </select>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr id="<?php echo $row['id'];?>">
               <td><?php echo $lidArr[$lid]['cname'];?></td>
...
$(function(){
	...
	$("#lid").change(function(){
		location.href = "/backend/Configure/jlks/"+$(this).val();
	});
	...
	$("#updateSubmit").click(function(){
		$.ajax({
            type: "post",
            url: '/backend/Configure/updateJlks/<?php echo $lid?>',
