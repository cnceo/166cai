...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      <li class="current"><a href="/backend/Configure/">开奖号码</a></li>
  ...
  <div class="data-table-filter">
  		<form action="/backend/Configure/" method="get"  id="search_form">
          <table>
            <tbody>
            <tr>
              <td colspan="4">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr id="<?php echo $row['id'];?>">
               <td data-index="<?php echo $row['lname']; ?>"><?php echo $ctypes[$row['ctype']];?></td>
...
$(function(){
	...
	$("#update").click(function(){
      ...
      html += '<tr><th></th><td><input type="hidden" name="lname" class="ipt w222" value="'+td.eq(0).data('index')+'"></td></tr>';
		$("#tbody").html(html);
		$("#updateId").val(id);
		popdialog("updatePop");
	});
	...
	$("#updateSubmit").click(function(){
		...
		$.ajax({
            ...
            data: $("#updateForm").serialize() + '&type ='+ type + '&names =开奖号码',
