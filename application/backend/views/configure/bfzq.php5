...
<div class="mod-tab mt20">
  <div class="mod-tab-hd">
    <ul>
      ...
      <li class="current"><a href="/backend/Configure/bfzq/">比分抓取</a></li>
  ...
  <div class="data-table-filter">
  		<form action="/backend/Configure/bfzq/" method="get"  id="search_form">
          <table>
            <tbody>
            <tr>
              <td colspan="4">
...
$(function(){
	...
	$("#updateSubmit").click(function(){
		...
		$.ajax({
            ...
            data: $("#updateForm").serialize()+ '&type ='+ type+ '&names =比分抓取',
