...
<div class="path">您的位置：<a href="">数据分析 </a>&nbsp;&gt;&nbsp;<a href="">充值</a></div>
<div class="data-table-filter mt10">
<form action="/backend/DataAnalysis/recharge" method="get"  id="search_form">
  <table>
    <colgroup>
        <col width="150">
        <col width="150">
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td><?php echo $avgTotal['avg_recharge_money'];?></td>
