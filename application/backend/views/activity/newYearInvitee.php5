...
<div class="mod-tab mt20 mb20">
	<div class="mod-tab-hd">
    	<ul>
            ...
            <li class="current"><a href="/backend/Activity/newYearInvitee">被分享人</a></li>
    	...
    	<ul>
      		<li style="display: block;">
        		<div class="data-table-filter mt10">
        			<form action="/backend/Activity/newYearInvitee" method="get" id="search_form">
	          			<table>
                            <colgroup>
                                <col width="200">
                                <col width="200">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $items['reg_created'];?></td>
