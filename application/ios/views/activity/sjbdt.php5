        ...
        <div class="pop-mask" style="display:block;">
            ...
            <div class="pop-redbag gold">
                ...
                <div class="text">
                  ...
                  <a href="/ios/activity/worldcup2018" class="btn yellow staff">返回活动首页</a>
                </div>
                <?php }else{ ?>
                <div class="text">
                    ...
                    <a href="/ios/redpack/index/<?php echo $token; ?>" class="btn yellow staff mb30">去看看</a>
                    <a href="/ios/activity/worldcup2018" class="back"><返回活动首页</a>
                </div>
                <?php } ?>
            </div>
            <?php }else{ ?>
