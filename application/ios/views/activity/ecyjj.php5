...
<head>
    ...
    <title>竞足加奖</title>
    <link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/static/css/active/plus-awards5.min.css');?>">
</head>
...
<body ontouchstart="">
    ...
    <script id="eurojj" type="text/html">
        <a href="javascript:;" target="_blank" class="plus-awards-hd">
            ...
            <p class="plus-awards-time" style="text-indent: 0">活动时间：{{dataInfo.header.time[indexTime]}}</p>
        </a>
    ...
    <script>
        $(function(){
			...
			$.get('/ajax/getTime', function(data){
				...
				$.get('/source/js/ecyjj.js?20180426', function() {
