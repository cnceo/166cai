    ...
    <div class="wrapper hot-events">
        ...
        <div class="hot-events-bd">
            ...
            <div class="hot-events-action btn-group">
                <a href="javascript:void(0)" onclick="window.webkit.messageHandlers.doBet.postMessage({lid: '51'});" class="btn bet-now">立即投注</a>
            </div>
            <div class="hot-events-action btn-group">
                <a href="javascript:void(0)" onclick="window.webkit.messageHandlers.jumpWeb.postMessage({url: 'https://www.baidu.com/'});" class="btn bet-now">跳转safari</a>
            </div>
            <!-- <div class="hot-events-action btn-group">
                <a href="javascript:void(0)" onclick="window.webkit.messageHandlers.forgetPayPwd.postMessage();" class="btn bet-now">忘记密码原生</a>
            </div> -->
            <div class="hot-events-action btn-group">
                <a href="javascript:void(0)" onclick="window.webkit.messageHandlers.getVersionCode.postMessage({});" class="btn bet-now">立即投注</a>
            </div>
        </div>
    </div>     
