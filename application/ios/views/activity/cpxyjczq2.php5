...
<body ontouchstart="">
    <div class="wrap">
        <ul class="course-list">
            ...
            <li><a href="javascript:;" onclick="window.webkit.messageHandlers.doBet.postMessage({lid:'42'});" target="_blank" class="link"><img src="<?php echo getStaticFile('/caipiaoimg/static/images/active/lottery-advanced/button.jpg');?>" alt=""></a></li>
        </ul>
    </div>
