...
<body>
            ...
            <ul class="ui-tab-content">
                <li class="current">
                    ...
                    <div class="nothing">暂无红包
                        ...
                        <a href="/ios/points/mall?type=1" class="goJF">兑换红包</a>
                        <?php } ?>
                    </div>
                    <?php else :?>
    ...
    <script>
        require(['//<?php echo DOMAIN;?>/caipiaoimg/static/js/lib/config.js'], function() {
            require(['Zepto', 'basic', 'ui/tips/src/tipsfix', 'ui/tab/src/tab', 'ui/loading/src/loadingfix', 'ui/scroller/src/oldscroll'], function($, basic, tips, tab, loading, scroll) {
