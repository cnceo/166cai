...
<body>
    <div class="wrapper recharge-result ios">
        ...
        <div class="recharge-result-ft">
            <div class="btn-group">
                <a class="btn btn-block-confirm btn-recharge" href="javascript:;" onclick="window.webkit.messageHandlers.goUser.postMessage({});">返回个人中心</a>
            </div>
