...
<?php 
	...
	{
		$class = 'ball-group ball-group-cmp';
		$blueClass = 'blue-ball';
	}
	else
	{
...
?>
	...
	?>
	<?php foreach ($redBalls as $val): ?><span><?php echo $val;?></span><?php endforeach; ?><?php foreach ($blueBalls as $val): ?><span class="<?php echo $blueClass;?>"><?php echo $val;?></span><?php endforeach; ?>
	    </div>
	</a>
    </li>
    <?php endforeach;?>