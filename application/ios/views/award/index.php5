...
<body>
    <div class="wrapper lottery-notice">
        <ul class="cp-list">
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::SSQ.'/'.$awards[Lottery_Model::SSQ]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::SFC.'/'.$awards[Lottery_Model::SFC]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/jczq/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/jclq/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::DLT.'/'.$awards[Lottery_Model::DLT]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::FCSD.'/'.$awards[Lottery_Model::FCSD]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::PLS.'/'.$awards[Lottery_Model::PLS]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::PLW.'/'.$awards[Lottery_Model::PLW]['seExpect'].'/';?>">
            ...
            <li>
                <a href="<?php echo $this->config->item('base_url').'awards/getAwardDetail/'.Lottery_Model::SYYDJ.'/'.$awards[Lottery_Model::SYYDJ]['seExpect'].'/';?>">
