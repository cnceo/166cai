...
{
	$config['php_path'] = '/opt/ios/php5/bin/php';
	$config['cmd_path'] = '/opt/case/www.166cai.com/ios/index.php';
...
else
{
	...
	$config['cmd_path'] = 'D:\wamp\web\cpbranch\ios\index.php';
	$config['log_threshold'] = 5; //日志配置
    ...
    $config['log_threshold'] = 5; //日志配置
    $config['SECRET'] = '123456789123456789123456';
    $config['cp_host'] = 'http://www.ka5188.com/';
    $config['defaultChannel'] = array(
        'web' => 1,
        'app' => 2,
    	'ios' => 3
...
$config['base_url'] = '//www.ka5188.com/ios/';
