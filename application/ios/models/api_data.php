...
class Api_Data extends MY_Model 
{
	...
	/*
 	 ...
 	 * @date:2015-04-17
 	 */
	public function getLotteryInfo($platform = 'ios', $ctype = 'lottery_info')
	{
	...
	/*
 	 ...
 	 * @date:2015-04-17
 	 */
	public function freshLotteryInfo($platform = 'ios', $ctype = 'lottery_info')
	{
		$REDIS = $this->config->item('REDIS');
        $ukey = "{$REDIS['APP_CONFIG']}{$ctype}_{$platform}";
		// $ukey = "{$REDIS['LOTTERY_INFO']}$platform";
	...
	/*
 	 ...
 	 * @date:2015-04-17
 	 */
	public function getAddInfo($platform = 'ios', $ctype = 'add_info')
	{
		$REDIS = $this->config->item('REDIS');
        $ukey = "{$REDIS['APP_CONFIG']}{$ctype}_{$platform}";
		$this->load->driver('cache', array('adapter' => 'redis'));
	...
	public function freshAddInfo($platform = 'ios') {
	    $REDIS = $this->config->item('REDIS');
