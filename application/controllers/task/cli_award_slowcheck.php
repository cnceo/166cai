...
class Cli_Award_Slowcheck extends Task_Controller
{
	private $startTime;
    public function __construct()
    {
        ...
        parent::__construct();
        register_shutdown_function(array($this->tlog, "fatalErrorHandler"), "awardSlowcheck");
    ...
    {
        $stopFlag = $this->backaward_model->slowBonusCheck($lid);
    	//当前任务操作
    	...
    	$this->tlog->infoHandler($this->startTime, $message, 'awardSlowcheck');
    }
}