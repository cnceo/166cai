...
class Cli_Chase_Bet_Slow extends MY_Controller
{
    ...
    public function statistics(){
        //追号统计脚本
        system("{$this->php_path} {$this->cmd_path} cron/cli_chase_statistics slowStatistics", $status);
    }

    public function chase()
    {
        //投单脚本
        system("{$this->php_path} {$this->cmd_path} cron/cli_chase_bet slowBet", $status);
    }
}