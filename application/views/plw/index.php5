...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.0/js/plw.js');?>"></script>
<script type="text/javascript">
var type = '<?php echo $plwType; ?>';
  ...
  <div class="mod-box-bd">
            ...
            <?php else: ?>
              <div class="ball-box-1 clearfix">
                ...
                <div class="fr">
                    <div></div>
                    <dl>
                      <dd class="filter-bigs">大</dd>
                      <dd class="filter-smalls">小</dd>
                      <dd class="filter-odds">奇</dd>
                      <dd class="filter-evens">偶</dd>
                      <dd class="filter-all">全</dd>
                      <dd class="clear-balls">清</dd>
                    </dl>
                </div>
              </div>
            <?php endif; ?>
    ...
    <div class="cast-basket">
      ...
      <div class="lotteryAdd box-collection">
        <div class="text">
          <div class="hr" style="width:880px;margin-left:-440px;"></div>
      ...
      <div class="lotteryBetArea">
        ...
        <dl>
          ...
          <dd class="lotteryList">
            <div class="fl border">
              ...
              <div class="history"><a target="_blank" href="<?php echo $baseUrl; ?>kaijiang/pl5">查看历史开奖号</a></div>
            </div>
            <div class="fr">
        ...
        <dl>
          ...
          <dd class="lotteryMessage">
            ...
            <?php if($lotteryConfig[PLW]['status']):?>
            ...
            <?php endif;?>
            <div class="lotteryMessageFour"><input class="ipt_checkbox" type="checkbox" checked="checked" id="agreenment1"><label for="agreenment1">我已阅读并同意</label><a href="javascript:;" class='lottery_pro'>《用户委托投注协议》</a><br><input class="ipt_checkbox" type="checkbox" checked="checked" id="agreenment2"><label for="agreenment2">我已阅读并同意</label><a href="javascript:;" class='risk_pro'>《限号投注风险须知》</a></div>
          </dd>
        </dl>
      </div>
      <!--投注信息-->
