  ...
  <div class="page" id="comm_page_">
	  ...
	  <span class="wirte">跳转到第<input type="text" id='skips' class="text" value='<?php //echo $cpage;?>' />页</span>
