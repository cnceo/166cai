			...
			<div class="mod_user">	
                <form class="form uc-form-list">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-con">
                            <input type="text" class="form-item-ipt vcontent" value="" name="id_card" data-rule="identification">
                            <div class="form-tip hide">
                                <i class="icon-tip"></i>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-con">
                            <input type="text" class="form-item-ipt vcontent" value="" name="con_id_card" data-rule="same" data-with="id_card">
                            <div class="form-tip hide">
                                <i class="icon-tip"></i>
