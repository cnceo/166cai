...
<?php endif; ?>
        var isHover = false;
        $(".lotteryTit .rule").hover(function(){
            isHover = true;
        ...
        $(".lotteryTit .det_pop").hover(function(){
            isHover = true;
        }, function(){
            isHover = false;
            $(this).hide();
...
<div class="lotteryTit issue mod-box-hd">
    ...
    <?php if ($lotteryId == SYXW): ?>
        ...
        <div class="fr last-award">
            <p>上一期第<em class="last-issue"></em>期     开奖结果</p>
    ...
    <?php elseif ($lotteryId == BJDC): ?>
        <div class="lotteryTitImg"><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/images/bg/indexBJDC.gif'); ?>" alt="北单" width="72" height="72" /></div>
        <div class="lotteryTitName">
    ...
    <?php elseif ($lotteryId == RJ): ?>
        ...
        <div class="fr last-award" style="width:240px;">
            <p>上一期第<em class="last-issue"></em>期     开奖结果</p>
            <div class="award-nums award-nums-nobg"></div>
            <div class="link-list">
    ...
    <?php elseif ($lotteryId == SSQ): ?>
        ...
        <div class="lotteryTitName">
            ...
            <p class="lottery-time">每周二、四、日晚21:15开奖</p>
        </div>
        <div class="fr last-award">
            <p>上一期第<em class="last-issue"></em>期     开奖结果</p>
            <div class="award-nums"></div>
    ...
    <?php else: ?>
        <div class="lotteryTitImg">
            <img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/cp-logo/cp-'.strtolower($enName).'.png');?>" alt="<?php echo $cnName; ?>" width="75" height="75" />
        </div>
        <div class="lotteryTitName">
