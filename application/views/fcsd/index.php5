...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.0/js/fcsd.min.js');?>"></script>
<script type="text/javascript">
var type = '<?php echo $fcsdType; ?>';
  ...
  <div class="mod-box-bd">
    ...
    <div class="userLottery">
        ...
        <div class="userLotteryBox clearfix">
            <?php echo $this->load->view('elements/fcsd/types'); ?>
            <?php if ($boxCount > 1): ?>
              <?php for ($i = 1; $i <= $boxCount; ++$i): ?>
                <div class="ball-box-<?php echo $i; ?> clearfix">
                  <div class="fl">
                      ...
                      <div><span><?php echo $typeMAP[$fcsdType]['rule']; ?></span></div>
                      <?php endif; ?>
                      <?php if ($i == 1): ?>
                      <h3>百位</h3>
                      <?php elseif ($i == 2): ?>
      ...
      <div class="lotteryBetArea">
        ...
        <dl>
          ...
          <dd class="lotteryList">
            <div class="fl border">
              ...
              <div class="history"><a target="_blank" href="<?php echo $baseUrl; ?>kaijiang/fc3d">查看历史开奖号</a></div>
            </div>
            <div class="fr">
        ...
        <dl>
          ...
          <dd class="lotteryMessage">
            ...
            <?php if($lotteryConfig[FCSD]['status']):?>
