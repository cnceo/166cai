...
<head> 
<meta charset="utf-8"> 
<meta name="discription" content="2345彩票学院频道专为网上购彩新手设计的教程，如果你对竞彩足球有兴趣，但尚未掌握专业技巧，小编手把手带您了解如何购买竞彩足球，如何提高中奖率等。2345彩票网100%安全购彩平台，中奖福地，赢家首选！">
<meta name="keywords" content="竞彩足球，彩票学院，彩票新手指南">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,minimal-ui"/>
<meta>
<title>手把手带你入门竞彩足球_彩票学院_彩票新手指南-2345彩票</title>
...
.icon-zuqiu, .jc-item .tips i, .jc-exp i, .jc-item .yellow-bg, .jc-item .yellow-bg span, .jc-odds li span, .jc-odds .arrow {
	background-image: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/sprite-icon.png')?>);
...
.jc-header {
	min-width: 1100px;
	height: 398px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-banner-bg.jpg')?>) center 0 no-repeat;
}
.jc-header h1 {
    font-size: 0;
	height: 100%;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-banner.jpg')?>) center 0 no-repeat;
	text-indent: -150%;
	overflow: hidden;
}
.jc-f, .jc-t, .jc-fi {
...
.jc-bread ol {
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/sprite-bread.png')?>) no-repeat;
	*zoom: 1;
}
.jc-bread .active2 {
...
.jc-item-title {
	margin: 0 auto 36px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/sprite-title.png')?>) no-repeat;
	text-indent: -150%;
	overflow: hidden;
}
.jc-f .jc-item-title {
...
<div class="active-font">
	...
	<div class="jc-main">
		...
		<div class="jc-f jc-item" id="jcF">
			<div class="jc-inner">
				...
				<div class="jc-img">
					<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-f-img1.png')?>" width="810" height="159" alt="">	
				</div>
				<div class="tips">
			...
			<div class="jc-inner">
				...
				<ol>
					<li>
						...
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-t-img1.png')?>" width="810" height="189" alt="">
						</div>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-t-img2.png')?>" width="810" height="150" alt="">
						</div>
						<p>计算结果如下，共计<b>4</b>注，每注<b>2</b>元，投注金额为<b>8</b>元</p>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-t-img3.png')?>" width="1012" height="55" alt="">
						</div>
						<br><br><br>
					</li>
					<li>
						...
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-t-img4.png')?>" width="1012" height="55" alt="">
						</div>
					</li>
				</ol>
				<div class="tips">
		...
		<div class="fixed-ie6">
			<div class="jc-inner">
				...
				<div class="jc-img">
					<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fo-img1.png')?>" width="810" height="159" alt="">
				</div>
				<p>我们整理一下，以投注<b>50</b>倍为例：</p>
				<div class="jc-img">
					<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fo-img2.png')?>" width="810" height="81" alt="">
				</div>
			...
			<div class="jc-inner">
				...
				<ul>
					<li>
						...
						<a href="http://caipiao.2345.com/jczq/spf?source=activity" class="jc-btn" target="_blank">投注胜平负</a>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fi-img1.png')?>" width="810" height="210" alt="">
						</div>
					</li>
					<li>
						<p class="yellow-bg png_bg"><span class="png_bg"><em>让球胜平负：</em>竞猜主队+ - 让球数的情况下全场90分钟内(含伤停补时)的比赛结果</span></p>
						<a href="http://caipiao.2345.com/jczq/rqspf?source=activity" class="jc-btn" target="_blank">投注让球胜平负</a>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fi-img2.png')?>" width="930" height="220" alt="">
						</div>
					</li>
					<li>
						<p class="yellow-bg png_bg"><span class="png_bg"><em>总进球：</em>竞猜对阵双方全场90分钟内(含伤停补时)的进球数之和</span></p>
						<a href="http://caipiao.2345.com/jczq/jqs?source=activity" class="jc-btn" target="_blank">投注总进球</a>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fi-img3.png')?>" width="720" height="200" alt="">
						</div>
					</li>
					<li>
						<p class="yellow-bg png_bg"><span class="png_bg"><em>半全场：</em>竞猜主队在上半场45分钟(含伤停补时)和全场90分钟内(含伤停补时)的胜平负结果</span></p>
						<a href="http://caipiao.2345.com/jczq/bqc?source=activity" class="jc-btn" target="_blank">投注半全场</a>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fi-img4.png')?>" width="710" height="159" alt="">
						</div>
					</li>
					<li>
						<p class="yellow-bg png_bg"><span class="png_bg"><em>比分：</em>比分就最简单啦，只要竞猜主队全场90分钟内(含伤停补时)的比分结果</span></p>
						<a href="http://caipiao.2345.com/jczq/cbf?source=activity" class="jc-btn" target="_blank">投注比分</a>
						<div class="jc-img">
							<img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/jczq/jc-fi-img5.png')?>" width="610" height="160" alt="">
						</div>
					</li>
				</ul>
				<div class="tips">
	...
	<div class="fixed-ie6">
		<p><b>都学会了吗？</b></p>
		<p class="slogan-action"><b>我们来投一注吧！</b><a href="http://caipiao.2345.com/jczq?source=bottom" class="jc-btn" target="_blank">立即投注</a></p>
	</div>
	</div>
	<div class="aside">
		<p>竞彩足球这么简单，<br>快来<em>赢取奖金</em>吧！</p>
		<a href="http://caipiao.2345.com/jczq?source=side" class="jc-btn" target="_blank">立即投注</a>
	</div>
</div>
