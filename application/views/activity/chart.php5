...
<html><head>
<meta charset="utf-8">
<title>双色球教你怎么看走势图_彩票学院_彩票新手指南-2345彩票</title>
<meta charset="utf-8"> 
<meta name="discription" content="2345彩票学院频道专为网上购彩新手设计的教程，双色球教你怎么看走势图，老彩迷都会看走势图，研究彩票走势在投注选号的过程有着至关重要的作用。2345彩票网100%安全购彩平台，中奖福地，赢家首选！">
<meta name="keyword" content="双色球教你怎么看走势图_彩票学院_彩票新手指南-2345彩票">
...
.bannercenter{ margin:0 auto; height:272px; background: url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/bannerbg.jpg');?>) no-repeat top center; background-size:cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;}
...
#forfix{ width:100%;}
.list_four{ width:1000px; height:50px; margin:0 auto; background:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/listbg.png');?>) no-repeat; overflow:hidden; zoom:1;}
...
.list_four a:hover,.list_four .curr{ background:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/hoverlist.png');?>) no-repeat; _background-image:none;_filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled='true', sizingMethod='image', src="../../caipiaoimg/v1.0/img/active/chart/hoverlist.png");}
...
.module_top span{ width:38px; height:64px; display:block; position:absolute; left:19px; top:-2px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-224px -114px; font-family:Arial; font-size:24px; font-weight:bold; line-height:78px; padding-left:12px; color:#f9625a; overflow:hidden;}
...
.module_even h3 span{ width:20px; height:20px; display:block; text-align:center; line-height:20px; color:#f9625a; font-size:14px; font-family:Arial; position:absolute; left:0; top:5px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-160px -135px;}
...
.liezi i{ width:15px; height:17px; display:block; background:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-183px -135px; margin:0 auto; margin-top:19px;}
...
.final h5{ padding-left:32px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:14px -181px; font-size:14px; color:#333;}
...
.antholiezi i{ width:15px; height:17px; display:block; position:absolute; left:0; top:2px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-180px -114px;}
...
.centerRoower{ width:40px; height:40px; display:inline-block; float:left; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-116px -114px; margin:208px 31px 0 31px;}
...
.antho_right p i{ width:15px; height:15px; display:block; position:absolute; left:0; top:4px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:-160px -114px;}
.last-qushi{ font-size:14px; color:#666; margin-top:15px; margin-bottom:25px;}
.goplay{ width:216px; height:54px; display:block; margin:0 auto; color:#fff; font-size:26px; font-weight:bold; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; line-height:54px; margin-bottom:60px; overflow:hidden; padding-left:60px;}
.goplay:hover{ background-position:left -57px;}
.gotoTop{ width:55px; height:55px; display:block; position:fixed; left:50%; margin-left:530px; bottom:135px; margin-top:-27px; background-image:url(<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/qushibg.png');?>); background-repeat:no-repeat; background-position:left -114px; display:none;}
...
.bannercenter h1 { width: 1000px; height: 329px; margin: 0 auto; background: url(../../caipiaoimg/v1.0/img/active/chart/banner.jpg) center 0 no-repeat; font-size: 0; text-indent: -250%; overflow: hidden;}
</style>
</head>
...
<div class="active-font">
	...
	<div class="bannerwarp">
    	<div class="bannercenter">
        	<!-- <img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/banner.jpg');?>"> -->
            <h1>双色球教你怎么看走势图</h1>
	...
	<div class="centerWarp">
                ...
                <div class="module_infor">
                	<div class="module_even">
                        ...
                        <div class="module_liezi">
                            ...
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic1.png');?>">
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic2.png');?>">
                        </div><!--module_liezi end-->
            ...
            <div class="countent_warp">
                ...
                <div class="module_infor">
                	<div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic3.png');?>">
                        </div><!--module_liezi end-->
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic4.png');?>">
                        </div><!--module_liezi end-->
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic5.png');?>">
                        </div><!--module_liezi end-->
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic6.png');?>">
                        </div><!--module_liezi end-->
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic7.png');?>">
                        </div><!--module_liezi end-->
            ...
            <div class="countent_warp">
                ...
                <div class="module_infor">
                    ...
                    <div class="module_even">
                        ...
                        <div class="module_liezi">
                        	<div class="liezi"><i></i><span>举个例子</span></div>
                            <img class="chartpic" src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/active/chart/charepic8.png');?>">
                        </div><!--module_liezi end-->
        ...
        <a class="goplay" href="http://caipiao.2345.com/ssq?source=bottom" target="_blank">投一注试试</a>
