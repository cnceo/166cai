    ...
    <div class="userLottery">
        ...
        <table class="lotteryTableCP matches">
            <tbody>
                ...
                <tr>
                    <td colspan="12" style="text-align: left; padding-left: 10px; font-weight: bold;"><?php echo $date; ?></td>
                </tr>
                ...
                <tr
                    ...
                    <td width="17.5%" rowspan="2"><?php echo $match['home']; ?></td>
                    <td width="17.5%" rowspan="2"><?php echo $match['awary']; ?></td>
                    <?php foreach ($jqsOptions as $key => $value): ?>
                    <td width="5%" rowspan="2" data-val="<?php echo $key; ?>" data-odd="<?php echo $match['jqsSp' . $key]; ?>">
                        <span class="jqs-option" >
