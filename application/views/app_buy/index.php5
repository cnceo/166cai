...
<meta charset="utf-8">
<title>2345彩票</title>
<meta content="2345彩票是2345集团公司旗下的彩票移动平台，提供双色球，竞彩足球，胜负彩，竞彩篮球，超级大乐透，老11选5等热门彩种投注服务，第一时间获取开奖公告信息和中奖信息，还有彩票资讯信息哦，随时随地购彩。2345彩票是彩民首选的100%安全购彩平台，中奖福地，赢家首选！" name="Description" />
<meta content="彩票，双色球，大乐透，胜负彩，竞彩足球" name="Keywords" />
<!--#include file="include/pub_css.htm"-->
<link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/v1.0/styles/app-download.css'); ?>">
...
<div class="header">
    <div class="wrap_in">
        <div class="logo-group">
            <h1 class="logo"><a href="http://caipiao.2345.com/"><span class="logo-txt">2345彩票网<small>A股上市公司旗下网站</small></span></a></h1>
...
<div class="app-dl">
  <div class="wrap_in app-dl-cnt">
    ...
    <div class="qrcode">
      <h3>扫描二维码下载</h3>
      <img src="<?php echo getStaticFile('/caipiaoimg/v1.0/images/app/qrcode.png');?>" alt="">
    </div>
    <div class="dl2pc">
      <h3>下载到电脑</h3>
      <a href="http://caipiao.2345.com/app/help/download" class="btn-dl-andr">安卓版</a>
    </div>
    <div class="dl2msg">
      <h3>短信获取下载地址</h3>
    ...
    <div class="app-show">
      <div class="slide" id="appShow">
        <div class="imgCon conList">
          <div class="con"><a href="javascript:;"><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/app/app-banner1.jpg');?>" width="203" height="361" alt="" /></a></div>
          <div class="con"><a href="javascript:;"><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/app/app-banner2.jpg');?>" width="203" height="361" alt="" /></a></div>
          <div class="con"><a href="javascript:;"><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/app/app-banner3.jpg');?>" width="203" height="361" alt="" /></a></div>
        </div>
        <div class="tab tabList"><i class="">•</i><i>•</i><i>•</i></div>
      </div>
    </div>
  </div>
  <p class="wrap_in app-introduce"><strong>2345彩票</strong>是2345集团公司旗下的彩票移动平台，提供双色球，竞彩足球，胜负彩，竞彩篮球，超级大乐透，老11选5等热门彩种投注服务，第一时间获取开奖公告信息和中奖信息，还有彩票资讯信息哦，随时随地购彩。2345彩票是彩民首选的100%安全购彩平台，中奖福地，赢家首选。</p>
</div>
...
<script src="<?php echo getStaticFile('/caipiaoimg/v1.0/js/slideFocus.js');?>" type="text/javascript"></script>
<script src="<?php echo getStaticFile('/caipiaoimg/v1.0/js/jquery.easing.1.3.min.js');?>" type="text/javascript"></script>
<script>
  $(function(){
