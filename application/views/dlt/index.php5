...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.0/js/dlt.min.js');?>"></script>
<!--容器-->
  ...
  <div class="mod-box-bd">
    ...
    <div class="userLottery">
        ...
        <div class="userLotteryBox clearfix">
            <div class="fl pre-box">
                ...
                <strong class="tagtit tagtit2" style="top:250px;">复式机选</strong>
                <div>
                    <span><em>红球区</em>选择5-35个红球</span>
                </div>
            ...
            <div class="fr post-box">
                <div>
                    <span><em>蓝球区</em>选择2-12个蓝球</span>
                </div>
                <ul class="balls clearfix" style="height:184px;">
                  <li>01</li>
                  <li>02</li>
                  <li>03</li>
                  <li>04</li>
    ...
    <div class="cast-basket">
      ...
      <div class="lotteryBetArea">
        ...
        <dl>
          ...
          <dd class="lotteryList">
            <div class="fl border">
              ...
              <div class="history"><a target="_blank" href="<?php echo $baseUrl; ?>kaijiang/dlt">查看历史开奖号</a></div>
            </div>
            <div class="fr">
        ...
        <dl class="lottery-additional">
          <dt>追加</dt>
          <dd><input autocomplete="off" type="checkbox" class='add-bet' id="zhuijia"><label for="zhuijia">追加投注（可中1600万）</label></dd>
        </dl>
        <dl>
          <dt>倍数</dt>
        ...
        <dl>
          ...
          <dd class="lotteryMessage">
            ...
            <?php if($lotteryConfig[DLT]['status']):?>
            	<div class="lotteryMessageThree"><a id="pd_dlt_buy" class="btn btn-deepRed submit <?php if (!$isLogin) echo 'not-login'; ?><?php echo $showBind ? ' not-bind': '';?>">确认投注</a></div>
            <?php else :?>
           		<div class="lotteryMessageThree"><a id="pd_dlt_buy" class="btn btn-disabled <?php if (!$isLogin) echo 'not-login'; ?><?php echo $showBind ? ' not-bind': '';?>">确认投注</a></div>
           	<?php endif;?>
            <div class="lotteryMessageFour"><input class="ipt_checkbox" type="checkbox" checked="checked" id="agreenment"><label for="agreenment">我已阅读并同意</label><a href="javascript:void(0);" class='lottery_pro'>《用户委托投注协议》</a></div>
          </dd>
        </dl>
      </div>
    </div>
