...
<div class="guide-pop <?php echo $sub; ?>" <?php if (!$this->is_new): ?> style="display:none;" <?php endif; ?> >
  ...
  <div class="guide-pop-inner step1">
    ...
    <div class="operate">
      ...
      <div class="inner">
        <h6>1.选择你预测的比赛结果</h6>
        <p>请至少选择<em class="cRed"><?php echo $desc; ?></em>场比赛</p>
        <ul class="step">
          <li class="active"></li>
          <li></li>
          <li></li>
...
<script>
    ...
    function open_newuserhelp(){
        var scrolltop = parseInt($('.guide-pop-jcrj .step1').css('top'), 10) - 220;
        $('body, html').animate({
          scrollTop: scrolltop
        }, 500);
        ...
        var elePassway = $('.guide-pop-jcrj .guide-pop-jc-castpanel-passway');
        var eleMultiple = $('.guide-pop-jcrj .guide-pop-jc-castpanel-multiple');
        var eleSubmit = $('.guide-pop-jcrj .guide-pop-jc-castpanel-submit');
        var timer;
