<!-- 新手帮助 start -->
<div class="guide-btn"><a href="javascript:;" onclick="open_newuserhelp()">新手引导</a></div>
<div class="pop-mask pop-mask-guide"  <?php if (!$this->is_new): ?> style="display:none;" <?php endif; ?> ></div>
<div class="guide-pop guide-pop-jclq <?php echo $sub; ?>" <?php if (!$this->is_new): ?> style="display:none;" <?php endif; ?> >
  <!--step1-->
  <div class="guide-pop-inner step1">
    ...
    <div class="operate">
      ...
      <div class="inner">
        ...
        <a class="btn btn-blue-allBind" href="javascript:;">下一步</a>
      </div>
      <a class="closed" href="javascript:" onclick="close_newuserhelp()"></a>
    </div>
  </div>
  <!--step2-->
  ...
  <div class="guide-pop-inner guide-pop-jc-castpanel guide-pop-jc-castpanel-submit" style="display:none;">
    ...
    <div class="operate">
      ...
      <div class="inner">
        ...
        <a class="btn btn-blue-allBind" href="javascript:;" onclick="close_newuserhelp()">立即体验</a>
      </div>
      <a class="closed" href="javascript:" onclick="close_newuserhelp()"></a>
    </div>
  </div>
...
<script>
    ...
    function open_newuserhelp(){
        var scrolltop = parseInt($('.guide-pop-jclq .step1').css('top'), 10) - 140;
        // 篮球-胜负 滚动少一点
        if($('.guide-pop').hasClass('guide-pop-jclq-sf')){
          scrolltop -= 60 
        }
        $('body, html').animate({
          scrollTop: scrolltop
        ...
        var elePassway = $('.guide-pop-jclq .guide-pop-jc-castpanel-passway');
        var eleMultiple = $('.guide-pop-jclq .guide-pop-jc-castpanel-multiple');
        var eleSubmit = $('.guide-pop-jclq .guide-pop-jc-castpanel-submit');
        var timer;

        setTimeout(castPanelAbout, 1000);
