            ...
            <div class="lotteryTableTH">
                <table class="lotteryTableTwo">
                    <tr>
                        ...
                        <th width="6%">编号</th>
                        <th width="12%">停售时间</th>
                        <th width="33%">主队VS客队</th>
                        <th width="13%">主队胜</th>
                        <th width="13%">平</th>
                        <th width="13%" class="last">客队胜</th>
                    </tr>
                </table>
                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['spfGd']): ?>
                                <tr
                                    ...
                                    <td width="33%" rowspan="2"><em class="team"><?php echo $match['home']; ?></em> VS
                                        <em
                                            class="team"><?php echo $match['awary']; ?></em></td>
                                    <td rowspan="2" width="13%"
                                        class="bgGray <?php if ($match['spfGd']): ?>spf-option<?php endif; ?>"
                                        data-val="3" data-odd="<?php echo $match['spfSp3']; ?>"><div class="pos-r">
                                    ...
                                    <td rowspan="2" width="13%"
                                        class="bgGray <?php if ($match['spfGd']): ?>spf-option<?php endif; ?>"
                                        data-val="1" data-odd="<?php echo $match['spfSp1']; ?>"><div class="pos-r">
                                        <?php if ( ! empty($match['spfFu'])): ?>
                                            <div class="single-pos"></div>
                                        <?php endif; ?>
                                        <?php if ($match['spfGd']) {
                                    ...
                                    <td rowspan="2" width="13%"
                                        class="bgGray <?php if ($match['spfGd']): ?>spf-option<?php endif; ?>"
                                        data-val="0" data-odd="<?php echo $match['spfSp0']; ?>"><div class="pos-r">
                                        <?php if ( ! empty($match['spfFu'])): ?>
                                            <div class="single-pos"></div>
                                        <?php endif; ?>
                                        <?php if ($match['spfGd']) {
