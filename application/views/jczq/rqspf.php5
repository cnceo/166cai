                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['rqspfGd']): ?>
                                <tr
                                    ...
                                    <td width="32%" rowspan="2"><em class="team"><?php echo $match['home']; ?></em> VS
                                        <em
                                            class="team"><?php echo $match['awary']; ?></em></td>
                                    <td width="10%" rowspan="2"><?php echo $match['let']; ?></td>
                                    <td rowspan="2" width="10%"
                                        class="bgGray <?php if ($match['rqspfGd']): ?>rqspf-option<?php endif; ?>"
                                        data-val="3" data-odd="<?php echo $match['rqspfSp3']; ?>"><div class="pos-r">
                                        <?php if ($match['rqspfGd']) {
                                            echo $match['rqspfSp3'];
                                        }
                                        else {
                                    ...
                                    <td rowspan="2" width="10%"
                                        class="bgGray <?php if ($match['rqspfGd']): ?>rqspf-option<?php endif; ?>"
                                        data-val="1" data-odd="<?php echo $match['rqspfSp1']; ?>"><div class="pos-r">
                                        <?php if ($match['rqspfGd']) {
                                            echo $match['rqspfSp1'];
                                        }
                                        else {
                                    ...
                                    <td rowspan="2" width="10%"
                                        class="bgGray <?php if ($match['rqspfGd']): ?>rqspf-option<?php endif; ?>"
                                        data-val="0" data-odd="<?php echo $match['rqspfSp0']; ?>"><div class="pos-r">
                                        <?php if ($match['rqspfGd']) {
                                            echo $match['rqspfSp0'];
                                        }
                                        else echo '停售' ?>
