                            ...
                            <?php if ($match['jqsGd']): ?>
                                <tr
                                    ...
                                    <?php foreach ($jqsOptions as $key => $value): ?>
                                        <td width="5%" class="bgGray jqs-option" rowspan="2"
                                            data-val="<?php echo $key; ?>"
                                            data-odd="<?php echo $match['jqsSp' . $key]; ?>"><div class="pos-r">
                                            <?php if ( ! empty($match['jqsFu'])): ?>
                                                <div class="single-pos"></div>
                                            <?php endif; ?>
                                            <?php echo empty($match['jqsGd']) ? '停售' : $match['jqsSp' . $key]; ?>
                                        </div></td>
                                    <?php endforeach; ?>
                                </tr>
