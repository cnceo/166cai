                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['sfcGd']): ?>
                                <tr
                                    ...
                                    <td width="16%" rowspan="2"><?php echo $match['weekId']; ?></td>
                                    <td width="20%">停售：<?php echo date('m-d H:i', $match['jzdt'] / 1000); ?></td>
                                    <td width="46%" rowspan="2"><em class="team"><?php echo $match['awary']; ?></em> VS
                                        <em
