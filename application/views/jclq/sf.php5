            ...
            <div class="lotteryTableTH">
                <table class="lotteryTableTwo">
                    <tr>
                        ...
                        <th width="6%">编号</th>
                        <th width="15%">停售时间</th>
                        <th width="37%">客队VS主队</th>
                        <th width="16%">主负</th>
                        <th width="16%" class="last">主胜</th>
                    </tr>
                </table>
                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['sfGd']): ?>
                                <tr
                                    ...
                                    <td width="37%" rowspan="2"><em class="team"><?php echo $match['awary']; ?></em> VS
                                        <em
                                    ...
                                    <td width="16%" rowspan="2"
                                        ...
                                        ><div class="pos-r"><?php if ( ! empty($match['sfFu'])): ?>
                                            <div class="single-pos"></div><?php endif; ?><?php if ($match['sfGd']) {
                                            echo $match['sfHf'];
                                        }
                                        else {
                                            echo '停售 ';
