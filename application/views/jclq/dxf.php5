            ...
            <div class="lotteryTableTH">
                <table class="lotteryTableTwo">
                    <tr>
                        ...
                        <th width="6%">编号</th>
                        <th width="15%">停售时间</th>
                        <th width="36%">客队VS主队</th>
                        <th width="11%">预设总分</th>
                        <th width="11%">大分</th>
                        <th width="11%" class="last">小分</th>
                    </tr>
                </table>
                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['dxfGd']): ?>
                                <tr
                                    ...
                                    <td width="36%" rowspan="2"><em class="team"><?php echo $match['awary']; ?></em> VS
                                        <em
                                            class="team"><?php echo $match['home']; ?></em></td>
                                    <td width="11%" rowspan="2"><?php if ($match['dxfGd']) {
                                            echo $match['preScore'];
                                        }
                                        else {
                                            echo '停售 ';
                                    ...
                                    <td width="11%" rowspan="2"
                                        ...
                                        ><div class="pos-r"><?php if ( ! empty($match['dxfFu'])): ?>
                                            <div class="single-pos"></div><?php endif; ?><?php if ($match['dxfGd']) {
                                            echo $match['dxfBig'];
                                        }
                                        else {
                                            echo '停售 ';
    ...
    <div class="lotteryZQCenter">
        ...
        <div class="seleFiveInfo">
            <ul class="clearfix">
                ...
                <?php else : ?>
                    <li class="last"><a id="pd_jczq_buy" class="btn btn-disabled seleViewRed <?php if ( ! $isLogin) {
                            echo 'not-login';
                        } ?><?php echo $showBind ? ' not-bind' : ''; ?>"> 立即投注</a></li>
                <?php endif; ?>
            </ul>
