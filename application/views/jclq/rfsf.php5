            ...
            <div class="lotteryTableTH">
                <table class="lotteryTableTwo">
                    <tr>
                        ...
                        <th width="6%">编号</th>
                        <th width="12%">停售时间</th>
                        <th width="34%">客队VS主队</th>
                        <th width="12%">让分</th>
                        <th width="13%">主负</th>
                        <th width="13%" class="last">主胜</th>
                    </tr>
                </table>
                        ...
                        <?php foreach ($dateMatch as $match): ?>
                            <?php if ($match['rfsfGd']): ?>
                                <tr
                                    ...
                                    <td width="34%" rowspan="2"><em class="team"><?php echo $match['awary']; ?></em> VS
                                        <em
                                            class="team"><?php echo $match['home']; ?></em></td>

                                    <td rowspan="2" width="12%"><?php echo $match['let']; ?></td>
                                    <td rowspan="2" width="13%"
                                        class="bgNumGray <?php if ($match['rfsfGd']): ?>rfsf-option<?php endif; ?>"
                                        data-val="0"
                                        data-odd="<?php echo $match['rfsfHf']; ?>"
                                        ><div class="pos-r"><?php if ( ! empty($match['rfsfFu'])): ?>
                                            <div class="single-pos"></div><?php endif; ?><?php if ($match['rfsfGd']) {
                                            echo $match['rfsfHf'];
                                        }
                                        else {
                                            echo '停售 ';
