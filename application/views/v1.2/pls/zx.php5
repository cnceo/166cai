...
var ISSUE = "<?php echo $info['next']['issue']?>", ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['next']['seFsendtime']/1000)?>", type = '<?php echo $plsType; ?>', boxCount = <?php echo $boxCount; ?>, 
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.2/js/pls.min.js');?>"></script>
<?php 
                       ...
                       <?php foreach ($miss as $mk => $ms): ?> 
                        <div class="bet-tab-bd-inner tab-radio <?php echo $mk?>" <?php if ($plsType !== $mk) {?> style="display:none" <?php }?> >
                            <div class="tab-radio-hd _radio_selected">
                                <ul>
                                    <li class="selected" data-url='pls?playType=zx'>
            ...
            <div class="cast-basket">
                <div class="bet-area-txt">
                    ...
                    <div class="multi-modifier">
                        ...
                        <a href="javascript:;" class="plus _plus" data-max="99">+</a>
                    </div>
...
<!--                       <div class="tab-radio-inner">
                ...
                <!-- 追号系统 end -->
                <div class="btn-group"> 
                  <a id="pd_pls_buy" class="btn btn-main  _gc_buy  <?php echo $showBind ? ' not-bind': '';?>">确认预约</a> 
