...
hmselling = '<?php echo $hmselling?>',realendTime = '<?php echo date('Y-m-d H:i:s', $info['next']['seEndtime']/1000)?>',playType = 1; //玩法
                       ...
                       <?php foreach ($miss as $mk => $ms): ?> 
                        <div class="bet-tab-bd-inner tab-radio <?php echo $mk?>" <?php if($fcsdType !== $mk) {echo 'style="display:none"';} ?> >
                            ...
                            <div class="tab-radio-bd">
                                  ...
                                  <!--直选-->
                                  <?php if ($mk == 'zx'): ?> 
                                  <div class="tab-radio-inner _zxInner">
                                      <div class="pick-area">
                                          <p class="pick-area-explain"><i class="icon-font">&#xe61b;</i>玩法说明：上传方案中的单式号码与开奖号码相同（且顺序一致）即中1040元！</p>
                                      </div>
                                      <div class="upload">
                                          <div class="rule">
                                              <h3>上传规则：</h3>
