...
<meta content="<?php echo $meta_desc; //@Author liusijia   ?>" name="Description" />
<meta content="<?php echo $meta_keywords; //@Author liusijia  ?>" name="Keywords" />
...
<link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/v1.1/styles/recharge.min.css');?>">
...
<div class="header header-short">
  <div class="wrap header-inner">
    ...
    <div class="aside">
        <a href="javascript:;" onclick="easemobim.bind({tenantId: '38338'})" class="btn online-service"><i class="icon-font">&#xe634;</i>在线客服</a>
