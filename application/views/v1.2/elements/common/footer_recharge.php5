...
<div class="footer">
  ...
  <div class="copyright">
    ...
    <div class="zzzz">
      <a href="//www.sgs.gov.cn/lz/licenseLink.do?method=licenceView&entyId=20160420173305831" target="_blank"><img src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/img-foot-yyzz.png');?>" width="109" height="32" alt="营业执照"></a>
...
<script type="text/javascript">var _userStatus = '<?php echo $this->uinfo['userStatus'] ?>';</script>
<script type="text/javascript" src='<?php echo getStaticFile('/caipiaoimg/v1.1/js/recharge.js');?>'></script>
