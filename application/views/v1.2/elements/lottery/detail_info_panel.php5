...
<div class="lotteryTit issue cp-box-hd">
    ...
    <div class="lottery-info lottery-<?php echo $enName?>">
        ...
        <div class="lottery-info-txt">
                <div class="lottery-info-top">
                    <h1 class="lottery-info-name"><?php if ($lotteryId == JXSYXW) {?>新11选5<?php }elseif ($lotteryId == HBSYXW) {?>惊喜11选5<?php }else {?>老11选5<?php }?></h1>
    ...
    <?php elseif (in_array($lotteryId, array(KS))): ?>
    <div class="lottery-info">
        ...
        <div class="lottery-info-txt">
                <div class="lottery-info-top"><h1 class="lottery-info-name">经典快3</h1><p class="lottery-info-num"><span><b>第<i class="curr-issue"><?php echo substr($info['next']['issue'], 2) ?></i>期</b></span></p></div>
                <div class="lottery-info-bt">
                    <div class="lnk-list">
		...
		<div class="lottery-info lottery-cqssc">
                ...
                <div class="lottery-info-txt">
                    <div class="lottery-info-top">
                        ...
                        <p class="lottery-info-num">第<b><?php echo $info['next']['issue'] ?></b>期</p>
                    </div>
                    <div class="lottery-info-bt">
                    <div class="lnk-list">
						<a href="<?php echo $baseUrl; ?>help/index/b<?php echo $help_center_rule[0]; ?>-s<?php echo $lottery_type[$enName]; ?>" class="no-bd-l" target="_blank"><i class="icon-font">&#xe60f;</i>玩法介绍</a><a href="/mylottery/betlog" target="_blank"><i class="icon-font">&#xe60c;</i>投注记录</a><a href="javascript:;" class="rule"><i class="icon-font">&#xe60d;</i>中奖规则</a>
                        <div class="det_pop" style="width: 660px;">
                            <div class="arr"></div>
				            <table width="695">
								<colgroup><col width="71"><col width="100"><col width="160"><col width="410"><col width="80"></colgroup>
								<thead><tr><th>玩法</th><th>开奖号码示例</th><th>投注号码示例</th><th>中奖规则</th><th>单注奖金</th></tr></thead>
								<tbody>
