...
<head>
    ...
    <script src="<?php echo getStaticFile('/caipiaoimg/v1.2/js/jlks.min.js');?>" type="text/javascript"></script>
...
<body>
    ...
    <div class="bet-k3 bet-jlks">
                        ...
                        <div class="bet-type-link-bd">
                            <div class="bet-type-link-item bet-type-link-item1 hz" data-tid="1" style="display: block;">
                                ...
                                <div class="pick-area-box">
                                    <div class="pre-box">
                                        <div class="pick-area">
                                            <div class="pick-area-tips"><ul><li class="current"><a href="javascript:;" class="bubble-tip" tiptext="指该号码自上次开出后没有出现的次数">遗漏</a><i></i></li><li><a href="javascript:;" class="bubble-tip" tiptext="指该号码近87期出现的次数">冷热</a><i></i></li></ul><div class="ptips-bd-t">指该号码自上次开出后没有出现的次数<b></b><s></s></div></div>
            ...
            <div class="lotteryZQbg cast-panel">
                <div class="lotteryZQCenter">
                    ...
                    <div class="seleFiveInfo">
                            ...
                            <li class="first">
                                <div class="passway">
                                    ...
                                    <div class="multi-modifier-s chase">
                                        ...
                                        <a href="javascript:;" class="plus" data-max="<?php echo count($chases) > 87? 87 : count($chases)?>">+</a>
                                    </div>
                                    期，</span>
                                </div>
                        ...
                        <?php if($lotteryConfig[JLKS]['status']):?>
        ...
        <div class="wrap bet-k3-ft">
            ...
            <dl><dt><i class="icon-font icon-arrow">&#xe62a;</i>投注风险提示</dt><dd><p>若用户设置的为中奖后停止追号的方案，则在执行追号过程中，发生某期追号方案直到当期网站销售截止前二分钟仍不明确上期追号的中奖状态，则网站会对当期追号方案做继续追号的处理。敬请知悉由此产生的追号风险。</p><p>查看<a href="/help/index/b5-s18" target="_blank">《玩法介绍》</a></p></dd></dl>
        </div>
