...
<head>
    ...
    <script>
    var KS_ISSUE = "<?php echo $info['cIssue']['seExpect']?>", ISSUE = KS_ISSUE, tm = <?php echo $info['cIssue']['seFsendtime']/1000-time();?>,
    ...
    <script src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/ks.min.js');?>" type="text/javascript"></script>
    <script src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/gaopin.min.js');?>" type="text/javascript"></script>
</head>
...
<body>
                    ...
                    <div class="inner">
                        <div class="bet-type-link-bd">
                            <div class="bet-type-link-item bet-type-link-item1 hz" data-tid="1" style="display: block;">
                                <div class="bet-pick-area">
                                    ...
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>所选和值与开奖的3个号码的和值相同即中奖，最高可中240元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：5</li><li>开奖：113
                                        </li><li>中奖：40元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="hz">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            ...
                                            <div class="table-zs-item ykj-info">
                                                <table>
                                                    <colgroup><col width="80"><col width="106"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36">
                                                    <col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="40"><col width="40"><col width="40"><col width="40"></colgroup>
                            ...
                            <div class="bet-type-link-item bet-type-link-item2 sthtx" data-tid="2">
                            	<div class="pick-area-note" style="display: none;"><span></span></div>
                            	<div class="pick-area-explain">
                                    <i class="icon-font">&#xe61b;</i>当开奖号码为三同号中任意一个时即中奖，单注奖金40元！
                                    <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：三同号通选</li><li>开奖：111</li><li>中奖：40元</li></ul>">&#xe613;</i></div>
                                </div>
                            	<div class="bet-pick-area">
                            		<div class="table-zs">
                            			<div class="table-zs-hd">
                            				<ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="sthtx">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                                            ...
                                            <div class="table-zs-item ykj-info">
                                                <table>
                                                    <colgroup>
                                                        <col width="80"><col width="106"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36">
                                                        <col width="36"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50">
                                                        <col width="36"><col width="36"><col width="36"><col width="36"><col width="36"><col width="36">
                                                    </colgroup>
                                                    <thead>
                                                        <tr>
                                                            <th rowspan="2">期次</th><th rowspan="2">开奖号码</th><th colspan="6">开奖号码分布</th>
                                                            <th colspan="6">开奖号码形态</th><th colspan="6">跨度走势</th>
                                                        </tr>
                                                        <tr>
                                                            <th><span>1</span></th><th><span>2</span></th><th><span>3</span></th><th><span>4</span></th>
                                                            <th><span>5</span></th><th><span>6</span></th><th><span>三同号</span></th><th><span>三不同</span></th>
                                                            <th><span>三连号</span></th><th><span>二同复</span></th><th><span>二同单</span></th><th><span>二不同</span></th>
                                                            <th><span>0</span></th><th><span>1</span></th><th><span>2</span></th><th><span>3</span></th>
                                                            <th><span>4</span></th><th><span>5</span></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
                                    ...
                                    <div class="pre-box">
                                        <div class="pick-area">
                                            <div class="pick-area-tips">
                                                <ul>
	                                                <li class="current"><a href="javascript:;" class="bubble-tip" tiptext="指该号码自上次开出后没有出现的次数">遗漏</a><i></i></li>
	                                                <li><a href="javascript:;" class="bubble-tip" tiptext="指该号码近82期出现的次数">冷热</a><i></i></li>
                                                </ul>
                                                <div class="ptips-bd-t">指该号码自上次开出后没有出现的次数<b></b><s></s></div>
                                            </div>
                                            <div class="pick-area-ball">
                                                <ol>
                                                    <li data-num='0,0,0'><a href="javascript:;"><?php for ($i = 1; $i <= 6; $i++) { echo "<b>".$i.$i.$i."</b>";}?><br>任意开出即中40元</a><i><?php echo $miss[2]?></i><em><?php echo $lenr[2]?></em><span>彩</span></li>
                                                </ol>
                                            </div>
                            ...
                            <div class="bet-type-link-item bet-type-link-item3 sthdx" data-tid="3">
                            	...
                            	<div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>从111～666中所选号码与开奖号码的3个号码相同即中奖，单注奖金240元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：222</li><li>开奖：222</li><li>中奖：240元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="sthdx">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                                                    <colgroup><col width="160"><col width="92"><col width="276"><col width="80"><col width="122"><col width="76"><col width="162"><col width="30"></colgroup>
                                                    <thead><tr><th>时间</th><th>期次</th><th>方案内容</th><th>订单金额</th><th>订单状态</th><th>我的奖金</th><th>操作</th>
                                                    <th class="tal"><a target="_blank" href="mylottery/betlog">更多</a></th></tr></thead><tbody></tbody>
                                                </table>
                                            </div>
                                            <div class="table-zs-item ykj-info">
                                                <table>
                                    ...
                                    <div class="pre-box">
                                        <div class="pick-area">
                                            ...
                                            <div class="pick-area-select has-btn">
                                                <a href="javascript:;" class="btn-ss btn-specail btn-mc rand-select">机选</a>
                            ...
                            <div class="bet-type-link-item bet-type-link-item4 sbth" data-tid="4">
                            	...
                            	<div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>所选号码与开奖号码的3个号码相同即中奖，单注奖金40元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：135</li><li>开奖：135</li><li>中奖：40元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="sbth">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                            ...
                            <div class="bet-type-link-item bet-type-link-item5 slhtx" data-tid="5">
                                ...
                                <div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>当开奖号码为三连号中任意一个时即中奖，单注奖金10元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：三连号通选</li><li>开奖：123</li><li>中奖：10元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="slhtx">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                                            ...
                                            <div class="table-zs-item ykj-info">
                                                <table>
                                                    ...
                                                    <thead>
                                                        <tr><th rowspan="2">期次</th><th rowspan="2">开奖号码</th><th colspan="6">开奖号码分布</th>
                                                        <th colspan="6">开奖号码形态</th><th colspan="6">跨度走势</th></tr>
                                                        <tr>
                                                            <th><span>1</span></th><th><span>2</span></th><th><span>3</span></th><th><span>4</span></th>
                                                            <th><span>5</span></th><th><span>6</span></th><th><span>三同号</span></th><th><span>三不同</span></th>
                                                            <th><span>三连号</span></th><th><span>二同复</span></th><th><span>二同单</span></th><th><span>二不同</span></th>
                                ...
                                <div class="pick-area-box">
                                    <div class="pre-box">
                                        <div class="pick-area">
                                            ...
                                            <div class="pick-area-ball">
                                                <ol>
                                                    <li data-num='0,0,0'><a href="javascript:;"><b>123</b><b>234</b><b>345</b><b>456</b><br>任意开出即中10元</a><i><?php echo $miss[5]?></i><em><?php echo $lenr[5]?></em><span>彩</span></li>
                                                </ol>
                                            </div>
                            ...
                            <div class="bet-type-link-item bet-type-link-item6 ethfx" data-tid="6">
                            	...
                            	<div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>开奖号码中包含所选择的对子即中奖，单注奖金15元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：11*</li><li>开奖：116</li><li>中奖：15元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="ethfx">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                            	...
                            	<div class="pick-area-box">
                                    <div class="pre-box">
                                        <div class="pick-area">
                                            ...
                                            <div class="pick-area-select has-btn">
                                                <a href="javascript:;" class="btn-ss btn-specail btn-mc rand-select">机选</a><a href="javascript:;" class="clear-balls">清空</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bet-type-link-item bet-type-link-item7 ethdx" data-tid="7">
                            	...
                            	<div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i> 选择1对相同号码和1个不同号码投注，选号与奖号相同（顺序不限），即中奖80元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：155</li><li>开奖：155</li><li>中奖：80元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="ethdx">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                                            ...
                                            <div class="table-zs-item ykj-info">
                                                <table>
                                                    ...
                                                    <thead>
                                                        <tr><th rowspan="2">期次</th><th rowspan="2">开奖号码</th><th colspan="6">开奖号码分布</th>
                                                        <th colspan="6">开奖号码形态</th><th colspan="6">跨度走势</th></tr>
                                                        <tr><th><span>1</span></th><th><span>2</span></th><th><span>3</span></th><th><span>4</span></th>
                                                        <th><span>5</span></th><th><span>6</span></th><th><span>三同号</span></th><th><span>三不同</span></th>
                                                        <th><span>三连号</span></th><th><span>二同复</span></th><th><span>二同单</span></th><th><span>二不同</span></th>
                                                        <th><span>0</span></th><th><span>1</span></th><th><span>2</span></th><th><span>3</span></th>
                                                        <th><span>4</span></th><th><span>5</span></th></tr>
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
                                                <div class="canvas-mask"></div>
                            ...
                            <div class="bet-type-link-item bet-type-link-item8 ebth" data-tid="8">
                            	...
                            	<div class="bet-pick-area">
                                    <div class="pick-area-explain">
                                        <i class="icon-font">&#xe61b;</i>所选号码与开奖号码任意2个号码相同即中奖，单注奖金8元！
                                        <div class="mod-tips"><i class="icon-font bubble-tip" tiptext="<ul><li>选号：12</li><li>开奖：123</li><li>中奖：8元</li></ul>">&#xe613;</i></div>
                                    </div>
                                    <div class="table-zs">
                                        <div class="table-zs-hd">
                                            <ul><li class="myorder"><a href="javascript:;">我的投注</a></li><li><a href="javascript:;" class="jqzs" data-playType="ebth">近期走势</a></li></ul>
                                        </div>
                                        <div class="table-zs-bd">
                                            <div class="table-zs-item my-order">
                                                <table>
                    ...
                    <div class="seleFiveWrap">
                        ...
                        <div class="seleFiveBox">
                            <div class="seleFiveBoxTit">
                                <table><colgroup><col width="100"><col width="260"><col width="56"><col width="63"></colgroup>
                    ...
                    <div class="seleFiveInfo">
                        <ul>
                            <li class="first">
                                <div class="passway">
                                    <p>
	                                    <a href="javascript:;" class="gg-type selected" data-orderType="0">自选</a>
	                                    <a href="javascript:;" class="gg-type" data-orderType="1">追号</a>
                                    </p>
                                    <div class="multi-modifier-s multi">
                                        <a href="javascript:;" class="minus">-</a>
                                        <label>
                                            <input class="multi number" type="text" value="1" autocomplete="off">
                                        </label>
                                    ...
                                    <div class="multi-modifier-s chase">
                                        <a href="javascript:;" class="minus">-</a>
                                        <label>
                                            <input class="chase number" type="text" value="10" autocomplete="off">
                                        </label>
                                ...
                                <div class="k3-qr" style="display: none;margin-top:0">
		                            ...
		                            <div class="mod-tips">
		                                <i class="icon-font bubble-tip" tiptext="<strong>中奖追停：</strong>勾选后，您的追号方案中的某一期中奖后，后续追号订单将被撤销，资金返还你的账户中。如不勾选，系统一直帮您购买所有的追号投注任务。">&#xe613;</i>
		                            </div>
		                        </div>
                            </li>
                        </ul>
        ...
        <div class="wrap bet-k3-ft">
            <dl>
                ...
                <dd>
                    <div class="k3-table-kj">
                        <table><colgroup><col width="15%"><col width="30%"><col width="25%"><col width="30%"></colgroup>
                        <thead><tr><th>期次</th><th>开奖号码</th><th>和值</th><th>形态</th></tr></thead><tbody></tbody></table>
                        <table><colgroup><col width="15%"><col width="30%"><col width="25%"><col width="30%"></colgroup>
                        <thead><tr><th>期次</th><th>开奖号码</th><th>和值</th><th>形态</th></tr></thead><tbody></tbody></table>
                        <table><colgroup><col width="15%"><col width="30%"><col width="25%"><col width="30%"></colgroup>
                        <thead><tr><th>期次</th><th>开奖号码</th><th>和值</th><th>形态</th></tr></thead><tbody></tbody></table>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <p>查看<a href="/help/index/b5-s14" target="_blank">《玩法介绍》</a></p>
                </dd>
            </dl>
        </div>
    ...
    $(function() {
		...
		<?php if ($editballs) {
			$str = '';
			foreach ($editballs as $key => $ballArr)  {?>
			$(".bet-type-link li:eq(<?php echo $key-1?>)").trigger('click');
			cx._basket_.balls[<?php echo $key-1?>].balls = [<?php echo $ballArr?>];
			<?php if ($key == 1) {
				foreach (explode(",", $ballArr) as $ball) {
				$str .= ",[data-num=".str_replace("'", '', $ball)."]";?>
			<?php }
			}else {
				foreach (explode("','", $ballArr) as $ball) {
				$str .= ",[data-num='".str_replace("'", '', $ball)."']";?>
		...
		$("<?php echo substr($str, 1)?>").addClass('selected');
        ...
        $('.pick-area-tips').on('click', 'li', function(){
            ...
            if($(this).find('a').text() == '冷热'){
                $(this).parents('.pick-area').find('.pick-area-ball').addClass('hot');
            }
        ...
        $('.side-menu-k3').on('click', '.past-award', function(){
            ...
            if (!$(".bet-k3-ft dd")[0].style.display) {
            	$(".bet-k3-ft dt").trigger('click')
            }
