...
<!--容器-->
<div class="wrap cp-box bet-jc jczq-zjq">
    ...
    <div class="cp-box-bd bet">
        <div class="bet-main">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <?php foreach ($jqsOptions as $key => $value): ?>
                                <th><?php echo $key == 7 ? '7或7+' : $value ?>球</th>
                            <?php endforeach; ?>
                        </tr>
                        </thead>
                    </table>
            ...
            <div class="jc-table-filter">
              ...
              <label for="xstsbs"><input id="xstsbs" name="jcFilter" name="jcFilter" checked="checked"   disabled="disabled" type="checkbox">显示已截止比赛(<i><?php echo $count['count'];?></i>场)</label>
                    ...
                    <dd class="select-opt">
                        <div class="select-opt-in">
                            <?php foreach ($dates as $key => $value): ?>
                                <a href="<?php echo $baseUrl; ?>jczq/jqs?date=<?php echo $value; ?>"><?php echo $key; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </dd>
                </dl>
         ...
         $("#xstsbs").click(function(){
            if($(this).is(':checked')){
              if($(".oldmatch").hasClass("hidden")){
                ...
                $.get('/jczq/getOldMatch?type=jqs',function(data){
                    $(".oldmatch").html(data);
                });
              }
            }else{
