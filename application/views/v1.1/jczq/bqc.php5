...
<!--容器-->
<div class="wrap cp-box bet-jc jczq-bqc">
                ...
                <div class="jc-table-hd">
                    <table>
                        ...
                        <tr>
                            ...
                            <?php foreach ($bqcOptions as $bqcOption): ?>
                                <th><?php echo str_replace('-', '', $bqcOption); ?></th>
                            <?php endforeach; ?>
                        </tr>
                        </thead>
                    </table>
                    ...
                    <dd class="select-opt">
                        <div class="select-opt-in">
                            <?php foreach ($dates as $key => $value): ?>
                                <a href="<?php echo $baseUrl; ?>jczq/bqc?date=<?php echo $value; ?>"><?php echo $key; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </dd>
                </dl>
                                        ...
                                        <?php if ($match['bqcGd']): ?>
                                            <tr
                                                ...
                                                <?php foreach ($bqcOptions as $key => $value): ?>
                                                    <?php $count ++; ?>
                                                    <td class="jc-option <?php echo $count == count($bqcOptions) ? 'no-bd-r' : ''; ?>">
                                                        <a class="bqc-option" onselectstart="return false;"
       ...
       $("#xstsbs").click(function(){
            if($(this).is(':checked')){
                if($(".oldmatch").hasClass("hidden") && match){
                    ...
                    if(hasload==0){
                        $.get('/jczq/getOldMatch?type=bqc',function(data){
                            $(".oldmatch").html(data);
                            match=data;
                            hasload=1;
                            if(data){
