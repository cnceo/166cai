...
<div class="wrap cp-box bet-jc jczq-dg">
    ...
    <div class="cp-box-bd bet">
                                                        ...
                                                        <td class="jc-option jc-option2 <?php if($match['full_score']) { echo "hasmatched";}?>">
                                                            <?php foreach (array('spf', 'rqspf') as $pt): ?>
                                                                <a class="<?php echo (($match[$pt . 'Fu'] && $match[$pt . 'Gd']) ? ($pt . '-option') : 'stop-selling') . ($pt == 'rqspf' ? ' no-bd-b' : ''); ?>
                                                                   <?php if(($match['result'][$pt]==$r) && !empty($match[$pt . 'Gd']) && $match['full_score'] && !empty($match[$pt . 'Fu']) && $match['m_status']!=1){ echo "bingo";} ?>"
        ...
        <div class="bet-side bet-bar">
            ...
            <p class="fcs"><span class="mr20">注数：<b><span class="bet-num">0</span></b>注</span><span>金额：<b><span
                            class="bet-money">0</span></b>元</span></p>

            <p class="fcs">预计奖金范围：<b class="min-money">0.00</b>-<b class="max-money">0.00</b>元</p>
