...
var QLC_ISSUE = "<?php echo $info['next']['issue']?>", ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['next']['seFsendtime']/1000)?>", chases = $.parseJSON('<?php echo json_encode($chases)?>'), chaselength = <?php echo $chaselength?>, 
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/qlc.js');?>"></script>
<!--容器-->
	...
	<div class="cp-box-bd bet">
		<div class="bet-main">
        	<div class="bet-link-bd">
        		<div class="bet-pick-area bet-tab">
	        		<div class="bet-tab-hd _bet_tab_hd">
	        			<ul>
	        				<li data-type="default"><a href='/qlc'>普通投注</a></li>
			...
			<div class="cast-basket">
				<div class="bet-area-txt">已选<strong class="num-multiple betNum _betNum">0</strong>注，投
					<div class="multi-modifier"><a href="javascript:;" class="_minus">-</a> <label><input class="_multi" type="text" value="<?php echo $multi?>" autocomplete="off"></label><a href="javascript:;" class="_plus" data-max="50">+</a></div>
...
<!-- 	                    <div class="tab-radio-inner">
	                            ...
	                            <table class="chase-number-table-hd">
	                                <thead>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <th><input type="text" class="ipt-txt follow-multi _follow-multi" data-max="50" value="<?php echo $multi?>">倍</th><th>方案金额（元）</th><th>预计开奖时间</th>
	                                    </tr>
	                                </thead>
	                            </table>
				...
				<div class="btn-group">
					...
					<a id="pd_qlc_buy" class="btn btn-main _gc_buy <?php echo $showBind ? ' not-bind': '';?>" style="display: none;">确认预约</a> 
