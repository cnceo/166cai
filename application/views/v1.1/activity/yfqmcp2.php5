...
<meta>
<title>166彩票-世界杯注册送166元红包</title>
<link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/v1.1/styles/global.min.css');?>">
<link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/v1.1/styles/active/one4.min.css');?>">
	...
	<div class="oneUser">
		<div class="wrap">
			...
			<div class="rule">
				<h2>活动规则</h2>
				<ol>
					<li><span>1、</span>活动时间：即日起至2018年7月15日。</li>
