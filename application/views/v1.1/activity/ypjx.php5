...
<head>
<meta charset="utf-8">
<meta name="Keywords" content="亚盘大解析，盘口，彩票学院，彩票新手指南，166彩票官网">
<title>亚盘大解析_彩票学院_彩票新手指南-166彩票官网</title>
...
.ypjq-header {
	min-width: 1000px;
	height: 370px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/banner-bg.jpg');?>) center 0 no-repeat;
}
.banner {
	position: relative;
	z-index: 10;
	...
	height: 240px;
	margin: 0 auto;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/banner.jpg');?>) center 0 no-repeat;
	font-size: 0;
	text-indent: -150%;
}
...
.item-2 {
	height: 694px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-2-bg.png');?>) center 0 no-repeat;
	color: #fff;
}
.item-3 {
	height: 537px;
...
.item-4 {
	height: 750px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-4-bg.png');?>) center 0 no-repeat;
	color: #fff;
}
.item-5 {
	height: 1094px;
...
h2 i s {
	...
	width: 85px;
	height: 49px;
	background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/num-fix.png');?>) center 0 no-repeat;
}
.main p {
	text-indent: 2em;
}
...
.item-arrow, .item-4 h3 i, .item-2 dd i, .aside a i, .icon-top, .icon-btm {
	background-image: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/sprite-icon.png');?>);
...
<body>
    ...
    <div class="active-font">
        ...
        <ol class="main">
    		<li class="item-1">
    			<div class="inner">
    				...
    				<div class="img-box">
    					<img width="561" height="448" alt="" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-1-img.png');?>">
    				</div>
    		...
    		<li class="item-3">
    			<div class="inner">
    				...
    				<div class="img-box">
    					<img width="778" height="227" alt="" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-3-img.png');?>">
    				</div>
    			</div>
    			<i class="item-arrow png_bg"></i>
    		</li>
    		...
    		<li class="item-5">
    			<div class="inner">
    				...
    				<div class="img-box">
    					<img width="748" height="259" alt="" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-5-img.png');?>">
    				</div>
    				...
    				<div class="img-box img-box-spe">
    					<img width="602" height="340" alt="" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/item-5-img2.png');?>">
    				</div>
        ...
        <div class="dg-footer">
        	<div class="inner">
        		<img alt="都学会了吗？来投一注试试！！" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ypjx/footer-img.png');?>">
        		<span class="lnk-go-large"><a href="/jczq?source=bottom" target="_blank">立即预约</a></span>
        	</div>
        </div>
<!--         <div class="aside"> -->
<!--         	 <div class="menu"> -->
