...
<script src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/shake.js'); ?>"></script>
...
<style>
    ...
    .ac-step .ac-mod-cot-bd li b, .ac-step .ac-mod-cot-bd .btn-active i, .ac-arrow {
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/sprite-active-rmb3.png'); ?>) no-repeat;
    }
    .ac-wrap {
        overflow-x: hidden;
        min-height: 100%;
    ...
    .ac-mod-cot {
        ...
        *zoom: 1;
        ...
        height: 200px;
        margin-bottom: 26px;
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/mod-cot-bg.png'); ?>) center 0 no-repeat;
        color: #fff;
    }
    .ac-mod-cot-hd {
        position: absolute;
    ...
    width: 1920px;
    height: 470px;
    background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/bg-bottom.png'); ?>) no-repeat;
    }
    .bg2 {
        width: 1920px;
    height: 470px;
    background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/bg-top.png'); ?>) no-repeat;
    }
    .bg3 {
        width: 800;
    height: 340;
    background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/slogan.png'); ?>) no-repeat;
    }
    .ac-slogan {
        width: 800px;
        height: 340px;
    ...
    .ac-hongbao .plaxify {
        width: 1000px;
        height: 280px;
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/hongbao.png'); ?>) no-repeat;
    }

    .ft-bg3 {
        width: 1920px;
        height: 82px;
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ft-bg3.png'); ?>) no-repeat;
    }
    .ft-bg2 {
        width: 1920px;
        height: 82px;
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ft-bg2.png'); ?>) no-repeat;
    }
    .ft-bg1 {
        width: 1920px;
        height: 82px;
        background: url(<?php echo getStaticFile('/caipiaoimg/v1.1/img/active/ft-bg1.png'); ?>) no-repeat;
    }
                  ...
                  <ul class="user_info">
                      <li>欢迎您，</li><li class="myaccount">
                          <a target="_blank" href="/mylottery/account" class="lotery_btn spec"><?php echo $this->uname;?><i class="my_lottery"></i></a><div class="drop_down">
                              <div class="row1">
                                  <a target="_blank" href="/wallet/withdraw">提现</a>
        ...
        <div class="ac-mod-cot ac-rule png_bg">
            ...
            <div class="ac-mod-cot-bd">
                <ol>
                    ...
                    <li>4、本活动最终解释权归2345彩票；如有疑问请联系<a href="javascript:;" onclick="easemobim.bind({tenantId: '38338'})" class="btn-specail online-service" target="_self">在线客服</a>或400-000-2345 转8 彩票业务。</li>
                </ol>  
            </div>
        </div>
    </div>
            ...
            $('#btn-getYzm').click(function(){
                ...
                if( !$(this).hasClass('disabled') )
                {
                    ...
                    $.ajax({
                       ...
                       data: {'phone':phone, 'position':<?php echo $position['activity_captche']?>},
                       success: function(response) {
                            if(!response) {
                                cx.Alert({
