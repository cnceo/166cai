        ...
        <div class="bet-main">
        	<div class="bet-link-bd">
        		<div class="bet-pick-area bet-tab">
	        	  <div class="bet-tab-hd _bet_tab_hd"><ul><li class='current' data-type="default"><a href="javascript:;">普通投注</a></li><li data-type="dt"><a href="javascript:;">胆拖投注</a></li><li data-type="ddsh"><a href="javascript:;">定胆杀号</a></li><li data-type="dssc"  class="dssc"><a href='/ssq/dssc'>单式上传</a></li></ul></div>
	            <!-- 数字彩投注区 start -->
	             <?php $this->load->view('v1.1/static/ssq_pickarea'); ?>
	             <!-- 数字彩投注区 end -->
             	</div>
             </div>
    ...
    <div class="bet-side">
      ...
      <div class="bet-side-item bet-side-notice">
        <h2 class="bet-side-title">
        	...
        	<a href="<?php echo $baseUrl; ?>/activity/xzcshb/?ssq" class="bet-side-qwimg" target="_blank"><img src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/zcshb.png');?>" width="106" height="28" alt="注册即送红包"></a>
        </h2>
