<?php 
if(!$lotteryConfig[HBSYXW]['status']) {
	$selling = 0;
}else {
	$selling = 2;
...
<script>
var HBSYXW_ISSUE = "<?php echo $info['cIssue']['seExpect']?>", ISSUE = HBSYXW_ISSUE, ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['cIssue']['seFsendtime']/1000)?>",
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/hbsyxw.min.js');?>"></script>
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/gaopin.min.js');?>"></script>
<div class="bet-syxw bet-hbsyxw">
            ...
            <div class="bet-main">
                <div class="bet-syxw-hd">
                    ...
                    <?php foreach ($typeMAP as $k => $type) {?>
                    	<li data-type="<?php echo $k?>" <?php if ($k == 'rx8'){?>class="selected"<?php }?>><a href="javascript:;"><?php echo $type['cnName']?><span>
                    	<?php if ($k == 'rx2') {?><u>易</u><?php 
                    	} elseif ($k == 'rx8') {?><u>热</u><?php 
                    	} elseif ($k == 'qzhi3') {?><u>高</u><?php }?><?php echo $type['bonus']?></span></a></li>
                    <?php }?>
                    </ul>
                    <span class="periods-num">已售<?php echo $count?>期，还剩<b class="main-color-s"><?php echo $rest?></b>期</span>
                </div>
                <div class="ykj-info">
                    <table>
                    ...
                    <div class="canvas-mask"></div><div class="ykj-info-mask"></div><div class="ykj-info-action">近期走势<i class="arrow"></i></div>
                </div>
                                        ...
                                        <div class="pick-area ball-box-1">
                                            ...
                                            <div class="pick-area-red pre-box">      
                                            	<div class="pick-area-tips">
                                                    ...
                                                    <div class="mod-tips">遗漏<div class="ptips-bd-t">指该号码自上次开出后没有出现的次数<b></b><s></s></div></div>
                                                </div>    
                                    ...
                                    <div class="pick-area-box">
                                        ...
                                        <div class="pick-area ball-box-1">
                                            ...
                                            <div class="pick-area-red pre-box">
                                                ...
                                                <div class="pick-area-hd"><em>胆码区</em>您认为必出的号码（<i class="main-color-s">选择1<?php if ($r !== 2) echo "-".($r-1)?>个</i>）</div>        
                                                <ol class="pick-area-ball balls">
                                                    <?php 
	                                                $i = 0;
	                                                foreach ($ms0 as $m) {
                                        ...
                                        <div class="pick-area ball-box-1">
                                            <div class="pick-area-red pre-box">
                                                <div class="pick-area-hd"><em>拖码区</em>您认为可能的号码（<i class="main-color-s">至少选择2个</i>）</div>        
                                                <ol class="pick-area-ball balls">
                                                    <?php 
	                                                $i = 0;
	                                                foreach ($ms0 as $m) {
                                                ...
                                                <div class="pick-all-box"><a href="javascript:;" class="filter-all">拖码全包</a><a href="javascript:;" class="clear-balls">清空</a></div>
                                            </div>
                                        </div> 
                                    </div>
                                    <!-- 数字彩投注区 end -->
	                            ...
	                            <table class="chase-number-table-hd">
	                                <thead>
	                                    ...
	                                    <tr>
	                                        <th>序号</th>
	                                        <th class="tal">
	                                            <input checked type="checkbox">追<input type="text" value="10" data-max="<?php echo count($chases) > 81 ? 81 : count($chases)?>" class="ipt-txt follow-issue">期<s>（共81期）</s>
	                                        </th>
                ...
                <!-- 追号系统 end -->
                        ...
                        <div class="btn-group">
                        	<a id="pd_hbsyxw_buy" class="btn btn-main btn-betting <?php echo $showBind ? ' not-bind': '';?>">确认预约</a>
