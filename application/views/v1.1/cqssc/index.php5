...
<script>
var CQSSC_ISSUE = "<?php echo $info['cIssue']['seExpect']?>", ISSUE = CQSSC_ISSUE, ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['cIssue']['seFsendtime']/1000)?>",
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/cqssc.min.js');?>"></script>
...
<div class="bet-syxw bet-cqssc">
            ...
            <div class="bet-main">
                <div class="bet-syxw-hd">
                    <ul class="bet-type-link">
                        <li data-type="1xzhi" class="selected"><a href="javascript:;">一星直选<span>10元</span></a></li>
                    ...
                    <div class="cast-basket">
                        ...
                        <div class="bet-area-txt">
                          ...
                          <div class="multi-modifier">
                            <a href="javascript:;" class="minus" onclick="clickCount('multi-modify')">-</a>
                            <label><input class="multi number" type="text" value="1" autocomplete="off"></label>
                            <a href="javascript:;" class="plus" onclick="clickCount('multi-modify')" data-max="10000">+</a>
                          </div>
    ...
    <div class="wrap bet-drop-ft">
        ...
        <dl>
            ...
            <dd>
                <p>若用户设置的为中奖后停止追号的方案，则在执行追号过程中，发生某期追号方案直到当期网站销售截止前一分钟仍不明确上期追号的中奖状态，则网站会对当期追号方案做继续追号的处理。敬请知悉由此产生的追号风险。</p>
