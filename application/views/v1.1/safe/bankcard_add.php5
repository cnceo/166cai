    ...
    <div class="form uc-form-list pl154 edit-form">
        <div class="form-item">
            ...
            <div class="form-item-con">
                <span class="name form-item-txt" id="realName"><?php echo cutstr($this->uinfo['real_name'], 0, 1);?></span>
                <span class="name form-item-txt" id="realNameShow" style="display:none;"><?php echo $this->uinfo['real_name'];?></span>
            </div>
        </div>
        <div class="form-item">
            <label class="form-item-label">身份证号：</label>
            <div class="form-item-con">
                <span class="bankCard-num form-item-txt" id="idCardHide"><?php echo cutstr($this->uinfo['id_card'], 0, 12);?></span>
                <a href="javascript:;" class="btn-veiw-more lnk-txt seeCard">查看完整信息</a>
            </div>
        </div>
        <div class="form-item">
