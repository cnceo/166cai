...
<div class="safe-item-box">
    <div class="form uc-form-list pl154" id="update-bank-list">
        <div class="form-item">
        ...
        if (!$(this).hasClass('disabled') && !getYzmLook) {
            ...
            $.ajax({
                ...
                success: function (response) {
                	timer(self);
                    if (response.status) {
                    	$('#update-bank-list input[name="imgCaptcha"]').attr('data-ajaxcheck', '0');
                    } else {
                    	recaptcha_reg();
                    	if(response.msg){
                        	$('#update-bank-list input[name="imgCaptcha"]').attr('data-ajaxcheck', '1');
