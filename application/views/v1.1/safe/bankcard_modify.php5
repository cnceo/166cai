...
<div class="safe-item-box">
    <div class="form uc-form-list pl154 edit-form">
        ...
        <div class="form-item">
            ...
            <div class="form-item-con"><span class="form-item-txt bankCard-num" id="idCardHide"><?php echo cutstr($this->uinfo['id_card'], 0, 12);?></span><a href="javascript:;" class="lnk-txt seeCard">查看完整信息</a></div>
        </div>
        <div class="form-item">
            ...
            <div class="form-item-con">
                <dl class="simu-select-med bank-select">
                    <dt>
                        <span class="_scontent" id="province" data-value="<?php echo $binfo['bank_type'];?>"><img src="<?php echo $this->config->item('pages_url')?>/caipiaoimg/v1.1/img/bank/<?php echo BanksDetail($binfo['bank_type'],'img');?>" alt=""><?php echo BanksDetail($binfo['bank_type'],'dname');?></span>
                        <i class="arrow"></i>
