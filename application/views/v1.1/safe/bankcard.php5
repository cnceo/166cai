...
<?php $isBind = $is_phone_bind && $is_id_bind; ?>
        ...
        <?php if($bankInfo):?>
            ...
            <li>
                <div class="bank-card bank-card-gs <?php if($bankList['is_default'] == '1'):?>bank-card-default<?php endif;?>">
                    <div class="bank-card-hd"><img src="/caipiaoimg/v1.1/img/bank/<?php echo BanksDetail($bankList['bank_type'],'img');?>" alt=""><?php echo BanksDetail($bankList['bank_type'],'name');?><i class="icon-default"></i></div>
...
<?php if($bankInfo) { $this->load->view('v1.1/safe/bankcard_pop');}?>
