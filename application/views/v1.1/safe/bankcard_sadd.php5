...
<ul class="steps-bar clearfix steps-bar2">
    ...
    <li class="last"><i>2</i><span class="des">验证完成</span></li>
</ul>
<div class="safe-item-box">
    <div class="form uc-form-list pl154 edit-form">
        <div class="form-item">
            <label class="form-item-label">真实姓名</label>
            <div class="form-item-con"><span class="name form-item-txt" id="realName"><?php echo cutstr($this->uinfo['real_name'], 0, 1);?></span><span class="name" id="realNameShow" style="display:none;"><?php echo $this->uinfo['real_name'];?></span></div>
        </div>
        <div class="form-item">
            <label class="form-item-label">身份证号</label>
            <div class="form-item-con"><span class="bankCard-num" id="idCardHide"><?php echo cutstr($this->uinfo['id_card'], 0, 12);?></span><a href="javascript:;" class="lnk-txt seeCard">查看完整信息</a></div>
        </div>
        <div class="form-item">
            ...
            <div class="form-item-con">
                <dl class="simu-select-med bank-select">
                    <dt>
                        <span class='_scontent' id='province' data-value=''>请选择</span>
                        <i class="arrow"></i>
                        <input type="hidden" class="vcontent" name='bank_type' value=''>
                    </dt>
                    <dd class="select-opt bank-select-opt">
                        <div class="bank-select-sp" data-name='bank_name'>
                            ...
                            <div class="bank-group-item">
                                <h3>24小时内到账:</h3>
                                <ul class="clearfix">
                                    <li><a href="javascript:;" target="_self" data-value='3230'><img src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/bank/bank-icon14.png'); ?>" alt="">中国邮政储蓄银行</a></li>
        ...
        <div class="form-item form-add">
            ...
            <div class="form-item-con">
                <input type='hidden' class='vcontent' name='action' value='_8'>
...
<div class="warm-tip mt30">
    <h3>温馨提示：</h3>
    <p>提现账户开户姓名必须与您在166彩填写的真实姓名一致，否则将提现失败。</p>
</div>
<script>
    //查看完整信息
		...
		if (!($(this).hasClass('disabled'))) {
			...
			$.ajax({
	            ...
	            success: function(response) {
	                ...
	                cx.PopCom.show('.pop-card-id');
	                cx.PopCom.close('.pop-card-id');
	                cx.PopCom.cancel('.pop-card-id');
