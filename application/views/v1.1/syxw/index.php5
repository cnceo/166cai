...
<script>
var SYXW_ISSUE = "<?php echo $info['cIssue']['seExpect']?>", ISSUE = SYXW_ISSUE, ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['cIssue']['seFsendtime']/1000)?>",
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/syxw.min.js');?>"></script>
                ...
                <div class="bet-syxw-bd">
                    ...
                    <?php }?>
                        ...
                        <div class="bet-type-link-item lexuan" style="display: none">
                            ...
                            <div class="bet-type-tab-bd">
                                <div class="bet-pick-area lexuan3">
                                    <div class="pick-area-box">
                                ...
                                <?php for ($r = 4; $r <= 5; $r++) {?>
                                <div class="bet-pick-area lexuan<?php echo $r?>">
                                    <div class="pick-area-box">
