...
var PLW_ISSUE = "<?php echo $info['next']['issue']?>", ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['next']['seFsendtime']/1000)?>", type = '<?php echo $plwType; ?>', boxCount = '<?php echo $boxCount; ?>', 
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/plw.js');?>"></script>
<?php 
            ...
            <div class="bet-link-bd">
                <div class="bet-pick-area bet-tab">
                    ...
                    <div class="bet-tab-hd _bet_tab_hd">
                        <ul>
                            <li  data-type="default"><a href="/plw">普通投注</a></li>
                            <li data-type="dssc" class="dssc current">单式上传</li>
                        </ul>
                    </div>
                    <!--玩法选项卡结束-->
                    <!--玩法切换区域-->
                    <div class="bet-tab-bd">
                        ...
                        <div class="bet-tab-bd-inner  dssc">
                            <div class="pick-area">
                                <p class="pick-area-explain"><i class="icon-font">&#xe61b;</i>玩法说明：上传方案中的单式号码与开奖号码相同（且顺序一致）即中10万元！</p>
                            </div>
                            <div class="upload">
                                <div class="rule">
                                    <h3>上传规则：</h3>
...
<!-- 	                    <div class="tab-radio-inner">
                ...
                <div class="btn-group">
                	...
                	<a id="pd_plw_buy" class="btn btn-main   _gc_buy <?php echo $showBind ? ' not-bind': '';?>" style="display: none;">确认预约</a> 
