<?php 
if(!$lotteryConfig[JXSYXW]['status']) {
	$selling = 0;
}else {
	$selling = 2;
...
<script>
var JXSYXW_ISSUE = "<?php echo $info['cIssue']['seExpect']?>", ISSUE = JXSYXW_ISSUE, ENDTIME = "<?php echo date('Y-m-d H:i:s', $info['cIssue']['seFsendtime']/1000)?>",
...
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/jxsyxw.min.js');?>"></script>
<script type="text/javascript" src="<?php echo getStaticFile('/caipiaoimg/v1.1/js/gaopin.min.js');?>"></script>
<div class="bet-syxw bet-jxsyxw">
        ...
        <div class="cp-box-bd bet">
            <div class="bet-main">
                ...
                <!-- 追号系统 end -->
                        ...
                        <div class="btn-group">
                            <a id="pd_jxsyxw_buy" class="btn btn-main btn-betting <?php echo $showBind ? ' not-bind': '';?>">确认预约</a>
