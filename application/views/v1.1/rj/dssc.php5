        ...
        <div class="bet-main">
            <div class="bet-link-bd">
                <div class="pick-area-box bet-tab">
                    ...
                    <div class="bet-tab-hd _bet_tab_hd">
                        <ul>
                            <li class="dssc <?php if($cz=='sfc'){echo ' current';}?>"><a href='sfc/dssc'>胜负彩</a></li>
                            <li class="dssc <?php if($cz=='rj'){echo ' current';}?>"><a href='javascript:;'>任选九</a></li>
                        </ul>
                    </div>
                    <div class="bet-tab-bd">
                        <div class="bet-tab-bd-inner">
                            <div class="pick-area">
                                <p class="pick-area-explain"><i class="icon-font"></i>玩法说明：上传方案中的单式号码与开奖号码相同，即中一等奖，最高奖金500万元！</p>
                            </div>
                            <div class="upload">
                                <div class="rule">
                                    <h3>上传规则：</h3>
            ...
            <div class="btn-group mb20">
                ...
                <a id="pd_sfc_buy" class="btn btn-main _gc_buy btn-betting
                        ...
                        <?php echo $showBind ? 'not-bind' : '' ?>" style="display: none;"><?php if($lotteryConfig[RJ]['status']):?>确认预约<?php else:?>暂停预约<?php endif;?></a>
