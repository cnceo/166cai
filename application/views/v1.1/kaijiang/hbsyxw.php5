...
<div class="wrap lottery-detail">
    <div class="l-frame">
        ...
        <div class="l-frame-cnt">
            <div class="lottery-detail-main lottery-syxw lottery-hbsyxw">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        <h1 class="lottery-detail-name">惊喜11选5开奖结果</h1>
                        <a href="<?php echo $baseUrl?>hbsyxw" target="_blank" class="btn-ss btn-ss-bet">立即预约</a>
                    </div>
                    ...
                    <p class="trend-chart"><a target="_blank" rel="nofollow" href="https://zoushi.166cai.cn/cjw11x5_qs/view/11x5_jiben-5-hub11x5-11.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
                                ...
                                <div class="date-select">
                                    ...
                                    <dl class="simu-select">
                                        ...
                                        <dd class="select-opt">
                                            ...
                                            while ($date > strtotime('2016-9-6')) {?>
												<a href="<?php echo $baseUrl?>kaijiang/hbsyxw/<?php echo date('Y-m-d', $date)?>"><?php echo date('Y-m-d', $date)?></a>
											<?php $date = $date - 86400;
											}?>
                                            </div>
                                        </dd>
                        ...
                        <div class="mod-box-bd">
                            ...
                            <table>
                                ...
                                <thead><tr><th class="table-algin-c">期次</th><th>开奖号码</th></tr></thead>
                                <tbody>
                                     <?php for ($issue = 64; $issue <= 81; $issue++) {
	                                $iss = str_pad($issue, 2, "0", STR_PAD_LEFT)?>
	                                	<tr>
	                                        <th><?php echo $iss?></th>
	                                        <td>
	                                ...
	                                <?php }?>
	                                <tr><th></th><td><div style= "width: 100%; overflow: hidden;"></div></td></tr>
                                    <tr><th></th><td><div style= "width: 100%; overflow: hidden;"></div></td></tr>
                                    <tr><th></th><td><div style= "width: 100%; overflow: hidden;"></div></td></tr>
                                </tbody>
                            </table>
