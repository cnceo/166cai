...
<div class="wrap lottery-detail">
    <div class="l-frame">
        ...
        <div class="l-frame-cnt">
            <div class="lottery-detail-main lottery-ks">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        <h1 class="lottery-detail-name">红快3开奖结果</h1>
                        <a href="<?php echo $baseUrl?>jxks" target="_blank" class="btn-ss btn-ss-bet">立即预约</a>
                    </div>
                                ...
                                <div class="date-select">
                                    ...
                                    <dl class="simu-select">
                                        ...
                                        <dd class="select-opt">
                                            ...
                                            while ($date > strtotime('2017-12-25')) {?>
												<a href="<?php echo $baseUrl?>kaijiang/jxks/<?php echo date('Y-m-d', $date)?>"><?php echo date('Y-m-d', $date)?></a>
											<?php $date = $date - 86400;
											}?>
                                            </div>
                                        </dd>
