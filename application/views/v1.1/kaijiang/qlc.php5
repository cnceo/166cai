...
<div class="wrap lottery-detail">
    <div class="l-frame">
        ...
        <div class="l-frame-cnt">
            <div class="lottery-detail-main lottery-qlc">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        <h1 class="lottery-detail-name">七乐彩开奖结果</h1>
                                ...
                                <dd class="select-opt">
                                    <div class="select-opt-in">
                                        <?php foreach ($issueList as $value){?>
                                    		<a href="<?php echo $baseUrl?>kaijiang/qlc/<?php echo $value['issue']?>"><?php echo $value['issue']?></a>
                                    	<?php }?>
                                    </div>
                                </dd>
                            </dl>
                        </div>
                        <a href="<?php echo $baseUrl?>qlc" target="_blank" class="btn-ss btn-ss-bet">立即预约</a> 
                    </div>
                    ...
                    <dl class="lottery-detail-dl">
                        ...
                        <dd>
                            <div class="award-nums">
                            	<?php foreach ($data['award']['red'] as $red){?><span class="ball ball-red"><?php echo $red?></span><?php }?><span class="ball ball-blue"><?php echo $data['award']['blue']?></span>
	                        </div>
                        </dd> 
                        <dt>全国销量：</dt>
                    ...
                    <p class="trend-chart"><a target="_blank" rel="nofollow" href="https://zoushi.166cai.cn/cjwqlc/view/qlcjiben.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
                        <div class="mod-box-hd">
                            <h2 class="mod-box-title">开奖详情</h2>
                            <span class="mod-box-subtxt">2元赢取500万,每周一、三、五开奖</span>
                        </div>
                            ...
                            <table> 
                                ...
                                <tbody>
                                	<?php if (empty($data['bonusDetail'])){?>
                                		<tr><td>一等奖</td><td>---</td><td>---</td><td><span class="ball-red">7</span>+<span class="ball-blue">0</span></td></tr>
                                		<tr><td>二等奖</td><td>---</td><td>---</td><td><span class="ball-red">6</span>+<span class="ball-blue">1</span></td></tr>
                                		<tr><td>三等奖</td><td>---</td><td>---</td><td><span class="ball-red">6</span>+<span class="ball-blue">0</span></td></tr>
                                		<tr><td>四等奖</td><td>---</td><td>---</td><td><span class="ball-red">5</span>+<span class="ball-blue">1</span></td></tr>
                                		<tr><td>五等奖</td><td>---</td><td>---</td><td><span class="ball-red">5</span>+<span class="ball-blue">0</span></td></tr>
                                		<tr><td>六等奖</td><td>---</td><td>---</td><td><span class="ball-red">4</span>+<span class="ball-blue">1</span></td></tr>
                                		<tr><td>七等奖</td><td>---</td><td>---</td><td><span class="ball-red">4</span>+<span class="ball-blue">0</span></td></tr>
									<?php }else {
