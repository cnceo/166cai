...
<div class="wrap lottery-detail">
    <div class="l-frame">
        ...
        <div class="l-frame-cnt">
            <div class="lottery-detail-main lottery-syxw lottery-jxsyxw">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        <h1 class="lottery-detail-name">新11选5开奖结果</h1>
                        <a href="<?php echo $baseUrl?>jxsyxw" target="_blank" class="btn-ss btn-ss-bet">立即预约</a>
                    </div>
                    ...
                    <p class="trend-chart"><a target="_blank" rel="nofollow" href="https://zoushi.166cai.cn/cjw11x5_qs/view/11x5_jiben-5-11x5-11.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
                                ...
                                <div class="date-select">
                                    ...
                                    <dl class="simu-select">
                                        ...
                                        <dd class="select-opt">
                                            ...
                                            while ($date > strtotime('2016-6-5')) {?>
												<a href="<?php echo $baseUrl?>kaijiang/jxsyxw/<?php echo date('Y-m-d', $date)?>"><?php echo date('Y-m-d', $date)?></a>
											<?php $date = $date - 86400;
											}?>
                                            </div>
                                        </dd>
