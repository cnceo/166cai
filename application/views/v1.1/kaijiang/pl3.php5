...
<div class="wrap lottery-detail">
    <div class="l-frame">
        ...
        <div class="l-frame-cnt">
            <div class="lottery-detail-main lottery-pls">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        ...
                        <a href="<?php echo $baseUrl?>pls" target="_blank" class="btn-ss btn-ss-bet">立即预约</a>
                    </div>
                    ...
                    <p class="trend-chart"><a target="_blank" rel="nofollow" href="https://zoushi.166cai.cn/cjwpl3/view/pl3_danxuan.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
