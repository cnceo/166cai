...
<form name='yeepay' action='<?php echo $params['reqURL_onLine']; ?>' method='post' accept-charset='gbk' onsubmit="document.charset='gbk';" >
...
<input type='hidden' name='pt_UserName'		value='<?php echo iconv('UTF-8', 'GB2312', $params['pt_UserName']); ?>'>
<input type='hidden' name='pt_PostalCode'	value='<?php echo $params['pt_PostalCode']; ?>'>
