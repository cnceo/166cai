<form target="recharge_phone" action='https://pay.2345.com/cardPay.php' method='post' class="form rchg_form" accept-charset="GB2312" >
    ...
    <div class="form-item">
        ...
        <div class="bank_list rechargeCard_list">
            <ul class="clearfix">
                <li data-val='1' class="selected"><img title="移动充值卡" alt="移动充值卡" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/bank/yidong.png');?>"><i class="s_yes"></i></li>
                <li data-val='2'><img title="联通充值卡" alt="联通充值卡" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/bank/liantong.png');?>"><i class="s_yes"></i></li>
                <li data-val='3'><img title="电信充值卡" alt="电信充值卡" src="<?php echo getStaticFile('/caipiaoimg/v1.1/img/bank/dianxin.png');?>"><i class="s_yes"></i></li>
            </ul>
        </div>
    </div>
    <div class="form-item">
    ...
    <div class="form-item btn-group">
        <div class="form-item-con">
            <a href="javascript:;" class="btn btn-main submit<?php echo $showBind ? ' not-bind': '';?>">立即充值</a>
