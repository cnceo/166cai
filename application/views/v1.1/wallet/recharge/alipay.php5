        ...
        <div class="cp-box-bd recharge-form">
            <form target="_blank" action="/wallet/recharge/processRecharge" method='post' class="form _recharge">
               <?php $this->load->view('v1.1/wallet/recharge/form_comm'); ?>
                ...
                <?php $this->load->view('v1.1/wallet/recharge/comm',array('isZfb'=>1)); ?>
                <!--开启结束-->
                <?php else: ?>
                <!--维护开始-->
                ...
                <!--维护结束-->
                <?php endif; ?>
                <div class="recharge-form-side"><a href="<?php echo $baseUrl;?>/mylottery/recharge" target="_blank">充值记录</a> <i class="line">|</i></div>
            </form>
        </div>
        <!--注意事件-->
