...
<div class="header header-short">
  <div class="wrap header-inner">
    <div class="logo">
    	...
    	<h1 class="header-title zfb-title">支付宝扫码支付</h1>
    </div>
  </div>
</div>
<div class="wrap pay-container p-dsf-pay p-zfb-pay" >
    <div class="cp-box">
        <form action="">
            ...
            <div class="pay-method-cont">
            	<div class="m-scan">
            		...
            		<div class="pay-dsf-qrcode">
                            <iframe style="width: 205px;height: 205px;" src="<?php echo $params['codeUrl'];?>">
    	            ...
    	            <img src="/caipiaoimg/v1.1/img/img-zfb-scan.png" width="210" height="200" class="scan-img-tips" alt="用'支付宝'扫一扫功能扫描此二维码付款">
    	            <div class="m-scan-tips">完成支付没有提示？
    	            	<div class="mod-tips-t">
    	            		在支付宝里完成支付，本页面未自动跳转，点击
