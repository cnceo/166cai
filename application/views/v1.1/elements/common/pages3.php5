  ...
  <div class="page" id="<?php echo $ajaxform?>_comm_page_">
	  ...
	  <span class="wirte" <?php if($cpage<1):?>style='display:none;'<?php endif;?>>跳转到第<input type="text" class="text skips" value='<?php //echo $cpage;?>' />页</span>
      <a href="<?php echo get_uri($cpage);?>" class="a_btn page_skip" <?php if($cpage<1):?>style='display:none;'<?php endif;?>>跳转</a>
  </div>
