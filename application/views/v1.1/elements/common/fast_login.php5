        ...
        <div class="no-login btn-group">
          <a href="javascript:;"  target="_self" class="btn btn-login not-login">用户登录</a><a href="javascript:;"  target="_self" class="btn-ss btn-specail register not-register">免费注册</a>
        </div>
        <?php else:?>
        <!-- 已登录 -->
