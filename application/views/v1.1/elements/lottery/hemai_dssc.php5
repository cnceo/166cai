<div class="buy-together">
	<form class="form">
		...
		<div class="form-item">
			...
			<div class="form-item-con"><div class="_getcomm commission"><ol class='_JHm'><li class="cur" data-val='0'>无</li><?php for ($i = 1; $i <= 10; $i++) {?><li data-val='<?php echo $i?>'><?php echo $i?>%</li><?php }?></ol><s>若方案盈利，盈利佣金=税后奖金*佣金比例</s></div></div>
		</div>
		<div class="form-item">
			<label for="" class="form-item-label"><em class="main-color-s">*</em>我要认购：</label>
			<div class="form-item-con _buyMoney"><input type="text" class="form-item-ipt _rgje" value='0'/>元<span class="small">发起人至少认购<em class="main-color-s _zsrg">5</em>%<u style="display: none">（已认购约<em class="main-color-s _yjrg">5</em>%）</u></span></div>
		</div>
		<div class="form-item">
			<label for="" class="form-item-label">我要保底：</label>
			<div class="form-item-con _guarantee">
				<input type="text" class="form-item-ipt _bdje" value='0'>元
				<span class="small">
					<label><input type="checkbox" class="form-item-checkbox _guaranteeAll">全额保底</label>最多可保底
                    <em class="main-color-s _zdblje">0</em>元<i class="icon-font bubble-tip" tiptext="<em>保底：</em>合买保底发起时，系统将会先从发起人帐<br>户内扣除相应的金额，若合买失败或者合买未全<br>部跟满，则会使用设置的保底金额自动购买未满<br>部分，以保证合买成功，若设置的保底金额还有<br>剩余资金，将自动退回到发起人的帐户内。">&#xe613;</i>
                    <u>（已保底约<em class="main-color-s _blbfb">0</em>%）</u>
				</span>
			</div>
		</div>
		<div class="form-item">
