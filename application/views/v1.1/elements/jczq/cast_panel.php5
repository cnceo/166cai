        ...
        <div class="lotteryZQCenter">
                ...
                <div class="seleFiveBox">
                    <div class="seleFiveBoxTit">
                        <table>
                            ...
                            <tr>
                            	<th width="60">序号</th>
                                <th width="83" class="tar"><span>主队</span></th>
								<th width="83" class="tal"><span>客队</span></th>
            ...
            <div class="seleFiveInfo">
                ...
                <ul class="has-matches clearfix panel-hide">
                    <li class="first">
                        <?php $this->load->view('v1.1/elements/jczq/gg_types'); ?>
                ...
                <a href="javascript:;" class="btn btn-specail btn-hemai <?php echo $lotteryConfig[JCZQ]['united_status'] ? '' : 'btn-disabled' ?> <?php echo $showBind ? 'not-bind' : '' ?>">发起合买</a>
                <a class="btn btn-main btn btn-betting
                <?php echo $lotteryConfig[JCZQ]['status'] ? 'submit' : 'btn-disabled' ?>
                <?php echo $showBind ? 'not-bind' : '' ?>
                "><?php if($lotteryConfig[JCZQ]['status']):?>确认预约<?php else:?>暂停预约<?php endif;?></a>
