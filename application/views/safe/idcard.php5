...
<div class="article">
        ...
        <form action="" class="form uc-form-list pl154">
            <div class="form-item">
                ...
                <div class="form-item-con">
                    <input type="text" class="form-item-ipt vcontent" data-rule='chinese' value="" name="real_name">
            ...
            <div class="form-item">
                ...
                <div class="form-item-con">
                    <input type="text" class="form-item-ipt vcontent" data-rule='identification' data-ajaxcheck='1' value="" name="id_card">
                    <div class="form-tip hide">
                        <i class="icon-tip"></i>
    ...
    <div class="warm-tip">
        <h3>温馨提示：</h3>
<!--		<p><em class="cOrange">1.真实姓名是您提款时的重要依据，填写后不可更改（请保证身份证姓名与银行卡姓名保持一致，否则无法提款）。</em></p>-->
