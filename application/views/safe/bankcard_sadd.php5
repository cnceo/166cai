...
<div class="safe-item-box">
    <form class="form uc-form-list pl154 edit-form">
        ...
        <div class="form-item">
            ...
            <div class="form-item-con"><span class="bankCard-num" id="idCardHide"><?php echo cutstr($this->uinfo['id_card'], 0, 12);?></span><span class="bankCard-num" id="idCardShow" style="display:none;"><?php echo $this->uinfo['id_card'];?></span><a href="javascript:;" class="lnk-txt" id="btn-veiw-more">查看完整信息</a></div>
        </div>
        <div class="form-item">
