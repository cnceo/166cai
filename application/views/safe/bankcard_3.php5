...
<div class="tit-b">
    <h2>添加银行卡</h2>
    <p class="tip cOrange">绑定银行卡可用于快捷充值与提款</p>
</div>
        ...
        <div class="form-item">
            ...
            <div class="form-item-con">
                <dl class="simu-select-med bank-select">
                    <dt><span class='_scontent' id='province' data-value='<?php echo $bank_type; ?>'><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/bank/bank-icon' . $bankIconMap[$bank_type] . '.png'); ?>" alt=""><?php echo $bankTypeList[$bank_type]; ?></span><i class="arrow"></i><input type="hidden" class="vcontent" name='bank_type' value='<?php echo $bank_type; ?>'></dt>
                    <dd class="select-opt bank-select-opt">
                        <div class="bank-select-sp" data-name='bank_name'>
                            ...
                            <div class="bank-group-item">
                                <h3>24小时内到账:</h3>
                                <ul class="clearfix">
                                    <li><a href="javascript:;" target="_self" data-value='3230'><img src="<?php echo getStaticFile('/caipiaoimg/v1.0/img/bank/bank-icon14.png'); ?>" alt="">邮政储蓄</a></li>
...
<div class="warm-tip mt30">
    <h3>温馨提示：</h3>
    <p>1.银行卡开户姓名必须与绑定的真实姓名一致，否则将提款失败。</p>
