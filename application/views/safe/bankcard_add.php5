...
<div class="safe-item-box">
    <form action="" class="form uc-form-list pl154 edit-form">
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="form-item-con">
                ...
                <span class="bankCard-num" id="idCardShow" style="display:none;"><?php echo $this->uinfo['id_card'];?></span>
                <a href="javascript:;" class="btn-veiw-more lnk-txt" id="btn-veiw-more">查看完整信息</a>
            </div>
        </div>
        <div class="form-item">
