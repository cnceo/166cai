        ...
        <form class="form uc-form-list pl154">
            <?php if (!empty($this->uinfo['phone'])): ?>
                <div class="form-item">
                    ...
                    <input type='hidden' class='vcontent' name='old_phone' value='<?php echo $this->uinfo['phone']; ?>'/>
                    <label class="form-item-label">原手机号码</label>
                ...
                <div class="form-item form-vcode">
                    ...
                    <div class="form-item-con">
                        <input type="text" class="form-item-ipt vyzm vcontent" data-rule='checkcode' value="" name="oldphoneyzm">
                        <a class="lnk-getvcode _timer" id='btn-getYzm1' href="javascript:;">获取语音验证码</a>
                        <span class="lnk-getvcode-disb hide">重新发送(<em id='_timer'>60</em>秒)</span>
                        <div class="form-tip hide">
                            <i class="icon-tip"></i>
                            <span class="form-tip-con oldphoneyzm tip"></span>
                            <s></s>
                        </div>
            ...
            <?php else: ?>
                ...
                <div class="form-item form-vcode">
                    ...
                    <div class="form-item-con">
                        ...
                        <a class="lnk-getvcode _timer" data-freeze='phone' id='btn-getYzm1' href="javascript:;">获取语音验证码</a>
                        <span class="lnk-getvcode-disb hide">重新发送(<em id='_timer'>60</em>秒)</span>
                        <div style="left: 0; top: 46px;" class="ui-poptip ui-poptip-yuyin">
                          <div class="ui-poptip-container">
                            <div class="ui-poptip-arrow-top"><i>◆</i><span>◆</span></div>
            ...
            new cx.vform('.safe-item-box', {
                ...
                submit: function(data) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == 2){
                                cx.Alert({content:'登录密码错误'});
                            }
                            else if(response == 3){
                                cx.Alert({content:'验证码错误'});
                                $('input[name="oldphoneyzm"]').focus();
                            }
                            else if(response == 4){
                                cx.Alert({content:'验证码错误'});
                            }
                                ...
                                self.renderTip('该手机号已被绑定过', $('.phone'));
                            }
                            else{
