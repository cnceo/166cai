...
<div class="wrap_in help-container lottery-detail">
    <div class="help-section clearfix">
        ...
        <div class="article">
            <div class="help-content lottery-detail-fcsd">
                ...
                <div class="lottery-detail-txt">
                    <div class="lottery-detail-title">
                        ...
                        <a href="<?php echo $baseUrl?>fcsd" target="_blank" class="btn btn-bet-small">立即投注</a>
                    </div>
                    ...
                    <p class="trend-chart"><a target="_blank" href="http://caipiao2345.cjcp.com.cn/cjw3d/view/3d_danxuan.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
