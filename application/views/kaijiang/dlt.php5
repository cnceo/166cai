        ...
        <div class="article">
            <div class="help-content lottery-detail-dlt">
                ...
                <div class="lottery-detail-txt">
                    ...
                    <p class="trend-chart"><a target="_blank" href="http://caipiao2345.cjcp.com.cn/cjwdlt/view/dltjiben.html">走势图</a><i>&raquo;</i></p>
                    <div class="mod-box">
                        ...
                        <div class="mod-box-bd">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td <?php if ($key !== '6dj') {?>rowspan="2"<?php }?>><?php echo $name?></td>
                                        ...
                                        <td <?php if ($key !== '6dj') {?>rowspan="2"<?php }?>><?php echo $condition?></td>
                                    </tr>
                                    <?php if ($key !== '6dj') {?>
	                                    <tr>
