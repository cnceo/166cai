    ...
    <div class="wrap-content">
        ...
        <?php }?>
          ...
          <div class="dkw-form-item yzm">
              ...
              <img id="imgCaptcha" src="<?php echo $this->config->item('pages_url'); ?>app/activity/captcha" alt="">
        ...
        <div class="dkw-form dkw-result" style="display: none;">
            ...
            <a href="<?php echo $this->config->item('pages_url'); ?>app/download/?c=<?php echo $version?>" target="_self" class="btn-click" id="btn-click">立即下载APP（2.35M）</a>
