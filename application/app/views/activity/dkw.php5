...
<head>
    ...
    <link rel="stylesheet" href="<?php echo getStaticFile('/caipiaoimg/static/css/active/dkw.min.css')?>">
</head>
<body ontouchstart="">
    <div class="wrap">
        <div class="wrap-content">
            ...
            <div class="dkw-form" id="send-before" style="display: block;">
                ...
                <div class="dkw-form-item yzm">
                    ...
                    <img id="imgCaptcha" src="/app/activity/captcha/1/dkwCaptcha" alt="">
            ...
            <div class="dkw-form dkw-result" id="send-after" style="display: none;">
                ...
                <a href="<?php echo $this->config->item('pages_url'); ?>app/download/?c=10107" class="btn-click" id="btn-click">立即下载APP使用</a>
        ...
        <div class="plus-rule">
            <ol class="rule-overflow-y">
                <li>1、活动时间：2017年01月12日 00:00:00-2017年02月03日 23:59:59；</li>
                <li>2、本次活动为2345贷款王用户专享，验证手机号后即可领取红包，每位用户限领一次；</li>
                <li>
                3、188元彩票红包价值如下：
                    <ol>
    ...
    require(['basic', 'ui/loading/src/loading', 'ui/tips/src/tips'], function(basic, loading, tips){
        ...
        $('.sendSms').on('click', function () {
            ...
            if( /1\d{10}$/.test(phone) ){
                $.ajax({
                    type: "post",
                    url: '/app/activity/sendEventSms/dkw',
        ...
        {
            $('#imgCaptcha').attr('src', '/app/activity/captcha/1/dkwCaptcha?v=' + Math.random());
        }
    });
</script>
