...
<body ontouchstart="">
    ...
    <script id="eurojj" type="text/html">
        ...
        <div class="plus-awards-bd">
            ...
            <div class="btn-group">
                <a href="javascript:;" onclick="bet.btnclick('42', 'jczq');" target="_blank" class="btn btn-special btn-join">投注竞彩足球</a>
                <a href="javascript:;" onclick="bet.btnclick('43', 'jclq');" target="_blank" class="btn btn-special btn-join">投注竞彩篮球</a>
            </div>
        </div>
    </script>
