      ...
      <div class="wrap-content">
        ...
        <div class="web-box">
          ...
          <template v-if="resData.status === '200'">
            ...
            <a href="javascript:;" @click="dlApp(), baidutj(['_trackEvent','wxhkapp', 'down', 'new'])" class="btn-click-w">马上下载客户端使用</a>
          </template>
          ...
          <template v-if="resData.status === '300'">
            <div class="popup">
                <div class="inner" @touchmove.prevent="">
                  ...
                  <a href="javascript:;" @click="dlApp(), baidutj(['_trackEvent','wxhkapp', 'down', 'old'])" class="btn go-share">前往分享贺卡</a>
                </div>
          ...
          <template v-if="resData.status === '500'">
            <div class="popup">
                <div class="inner" @touchmove.prevent="">
                  ...
                  <p>快来开启千万大奖</p>
                  <span class="close" @click.prevent="resData.status = '400'">&times;</span>
                  <a href="javascript:;" @click="dlApp(), baidutj(['_trackEvent','wxhkapp', 'down', 'old'])" class="btn go-share">下载客户端使用</a>
                </div>
                <div class="mask" @touchmove.prevent=""></div>
            </div>
          </template>
    ...
    var newUser = new Vue({
      ...
      data: function () {
        return {
          ...
          api: {
            register: '/app/activity/xnhkDoRegister'
          },
          showHK: true,
          hk: {
            cur: 0,
      ...
      methods: {
        open:function (){
        	  ...
        	  _hmt.push(['_trackEvent','wxhkapp', 'open']);
        },
        ...
        postEvent: function () {
        	_hmt.push(['_trackEvent','wxhkapp', 'click']);
          var _this = this;
              ...
              this.$http.post(this.api.register, data, {
                ...
                if (_this.resData.status === '100') {
                  ...
                  this.toast.text = _this.resData.msg;
                	...
                	_hmt.push(['_trackEvent','wxhkapp', 'click', 'get']);
                }
        ...
        dlApp: function () {
        	// _hmt.push(['_trackEvent','wxhkapp', 'download']);
            if (this.openAppFlag) {
