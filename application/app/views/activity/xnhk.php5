        ...
        <div class="join-wrap" v-if="!showHk">
            <div class="join-bd ui-tab">
                ...
                <div class="ui-tab-content">
                    ...
                    <div class="join-tab-item" v-if="tab.curIdx === 1">
                        ...
                        <?php if($awards):?>
                    		<a href="/app/redpack/index/<?php echo $token;?>" class="go-rp">查看奖品</a>
                    	<?php endif;?>
                    </div>
                </div>
            </div>
            <div class="popup bingo" v-if="result">
                <div class="inner" @touchmove.prevent="">
                    ...
                    <p class="sub-link"><a href="/app/redpack/index/<?php echo $token;?>">立即查看</a></p>
                </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                goChooseHk: function () {
                	...
                	_hmt.push(['_trackEvent', 'appxnhk', 'pick']);
                ...
                share: function () {
                    if (!this.isLogin()) return;
                    _hmt.push(['_trackEvent','appxnhk', 'share']);
                    try {
                        android.shareSocialMedia("我给你做了张贺卡","快打开看看~还有166元新年豪礼相送！>>","<?php echo $imgurl?>",this.url);
                    } catch (err) {
                        console.log(err);
                    }
                }
