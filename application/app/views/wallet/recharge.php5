            ...
            <ul class="cp-list">
                <li>
                    <div class="cp-form-item">
                        ...
                        <input name="rechargeMoney" type="tel" id="rechargeNumIpt" class="recharge-num-ipt" min="1" maxlength="8" placeholder="请至少充值10元" value="20"><span>元</span>
                    </div> 
                </li>
            </ul>
	            ...
	            <ul class="cp-list">
	                ...
	                <li>
	                    <div class="cp-list-txt">
	                        ...
	                        maxmoney="<?php echo $detail['maxmoney']?>" jsaction="<?php echo $detail['jsaction']?>" <?php echo ($detail['idName'] == $checked_idName)?'checked':''; ?>>
