...
<body>
    <div class="wrapper sMessge">
        ...
        <ul class="cp-list cp-list-senior">
            <li>
                <div class="cp-list-txt">
                    <h4 class="cell-l">非高频彩出票状态更新通知推送</h4>
                    <label class="cell-r ui-switch" data-index="order_draw_s">
                        <input <?php echo ($order_draw_s)?'checked':''; ?> type="checkbox" name="order_draw_s">
                    </label>
                </div>
            </li>
        </ul>
        <ul class="cp-list cp-list-senior">
            <li>
                <div class="cp-list-txt">
                    <h4 class="cell-l">高频彩出票状态更新通知推送</h4>
                    <label class="cell-r ui-switch" data-index="order_draw_f">
                        <input <?php echo ($order_draw_f)?'checked':''; ?> type="checkbox" name="order_draw_f">
                    </label>
                </div>
            </li>
        </ul>
        <p class="tips">关闭此配置依然会收到出票失败推送通知。</p>
        <ul class="cp-list cp-list-senior">
            <li>
                <div class="cp-list-txt">
