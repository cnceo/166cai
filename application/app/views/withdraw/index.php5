    ...
    <div class="wrapper cp-box-b withdraw-money">
        ...
        <div class="cp-box-bd">
            <ul class="cp-list bankcard-box">
                <li>
                    <a href="<?php echo $this->config->item('pages_url'); ?>app/withdraw/apply/<?php echo $token;?>">
        ...
        <form class="cp-form" action="" autocomplete="off">
            <div class="form-group">
                ...
                <div class="form-item">
                    ...
                    <input name="moneyNum" type="tel" id="moneyNum" class="recharge-num-ipt" placeholder="单笔提现金额最少为10元" >
