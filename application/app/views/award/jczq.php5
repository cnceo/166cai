                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <div class="lottery-result-num" id="minfo<?php echo $match['mid']; ?>">
                                    <span><?php echo $match["home"];?>(<?php echo $match["let"];?>)</span><em class="special-color"><?php echo $match["score"];?></em><span><?php echo $match["awary"];?></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td><b><?php echo $match["spf"];?></b></td>
                            <td><b><?php echo $match["rqspf"];?></b></td>
                            <td><b><?php echo $match["jqs"];?></b></td>
                            <td><b><?php echo $match["bqc"];?></b></td>
                        </tr>
                        <tr>
        ...
        require(['basic', 'ui/loading/src/loading', 'ui/tips/src/tips'], function(basic, loading, tips){
            ...
            $('.showDetails').on('tap', function(){
                if(stop){
                    ...
                    $.ajax({
                        type: 'get',
                        url: '/app/awards/jczqDetail?mid=' + mid,
