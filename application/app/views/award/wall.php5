...
<body>
    <div class="wrapper bonus-rank" id="bonus" v-cloak>
        ...
        <qbet order-api="/app/order/createOrder" lid="<?php echo $lottery['lid']; ?>" issue="<?php echo $lottery['issue']; ?>" end-time="<?php echo $lottery['endTime']; ?>" title="<?php echo $lottery['title']; ?>" slogan="<?php echo $lottery['slogan']; ?>" @on-bet="betCb" @on-handle="doSuccess" @on-error="doError"></qbet>
