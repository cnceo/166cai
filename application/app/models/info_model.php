...
class Info_Model extends MY_Model
{
    ...
    public function getInfoList($categoryId, $cpage, $psize)
    {
        ...
        where category_id = ? and platform & 2 and is_show = 1 order by is_top DESC, show_time DESC limit " . ($cpage - 1) * $psize . ", $psize";
    ...
    {
        $sql = "update cp_info set num = num + 1 where id = ?";
